#  MINLP written by GAMS Convert at 08/03/20 15:07:24
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.x5 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.972759)
m.x6 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.972759)
m.x7 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.972759)
m.x8 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.972759)
...
m.x13 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.969394)
m.x14 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.969394)
m.x15 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.969394)
m.x16 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.969394)
...
m.x21 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.980003)
m.x22 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.980003)
m.x23 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.980003)
m.x24 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.980003)
m.x25 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.987427)
m.x26 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.987427)
m.x27 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.987427)
m.x28 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.987427)
...
m.x33 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.003573)
m.x34 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.003573)
m.x35 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.003573)
m.x36 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.003573)
m.x37 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.011626)
m.x38 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.011626)
m.x39 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.011626)
m.x40 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.011626)
m.x41 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.990837)
m.x42 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.990837)
m.x43 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.990837)
m.x44 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.990837)
m.x45 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.042513)
m.x46 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.042513)
m.x47 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.042513)
m.x48 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.042513)
m.x49 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.973546)
m.x50 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.973546)
m.x51 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.973546)
m.x52 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.973546)
m.x53 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.0342)
m.x54 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.0342)
m.x55 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.0342)
m.x56 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.0342)
m.x57 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.005716)
m.x58 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.005716)
m.x59 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.005716)
m.x60 = Var(within=Reals,bounds=(0.9,1.05),initialize=1.005716)
...
m.x65 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.998853)
m.x66 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.998853)
m.x67 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.998853)
m.x68 = Var(within=Reals,bounds=(0.9,1.05),initialize=0.998853)
...
m.c365 = Constraint(expr=   m.x429 <= -0.421052631578947)

m.c366 = Constraint(expr=   m.x430 <= -0.421052631578947)

m.c367 = Constraint(expr=   m.x431 <= -0.421052631578947)

m.c368 = Constraint(expr=   m.x432 <= -0.421052631578947)

m.c369 = Constraint(expr=   m.x433 <= -0.947368421052632)

m.c370 = Constraint(expr=   m.x434 <= -0.947368421052632)

m.c371 = Constraint(expr=   m.x435 <= -0.947368421052632)

m.c372 = Constraint(expr=   m.x436 <= -0.947368421052632)
...
m.c385 = Constraint(expr=   m.x453 <= -0.421052631578947)

m.c386 = Constraint(expr=   m.x454 <= -0.421052631578947)

m.c387 = Constraint(expr=   m.x455 <= -0.421052631578947)

m.c388 = Constraint(expr=   m.x456 <= -0.421052631578947)

m.c389 = Constraint(expr=   m.x457 <= -0.315789473684211)

m.c390 = Constraint(expr=   m.x458 <= -0.315789473684211)

m.c391 = Constraint(expr=   m.x459 <= -0.315789473684211)

m.c392 = Constraint(expr=   m.x460 <= -0.315789473684211)

m.c393 = Constraint(expr=   m.x461 <= -0.526315789473684)

m.c394 = Constraint(expr=   m.x462 <= -0.526315789473684)

m.c395 = Constraint(expr=   m.x463 <= -0.526315789473684)

m.c396 = Constraint(expr=   m.x464 <= -0.526315789473684)

m.c397 = Constraint(expr=   m.x465 <= -1.57894736842105)

m.c398 = Constraint(expr=   m.x466 <= -1.57894736842105)

m.c399 = Constraint(expr=   m.x467 <= -1.57894736842105)

m.c400 = Constraint(expr=   m.x468 <= -1.57894736842105)
...
m.c413 = Constraint(expr=   m.x497 <= -0.105263157894737)

m.c414 = Constraint(expr=   m.x498 <= -0.105263157894737)

m.c415 = Constraint(expr=   m.x499 <= -0.105263157894737)

m.c416 = Constraint(expr=   m.x500 <= -0.105263157894737)

m.c417 = Constraint(expr=   m.x501 <= -0.242105263157895)

m.c418 = Constraint(expr=   m.x502 <= -0.242105263157895)

m.c419 = Constraint(expr=   m.x503 <= -0.242105263157895)

m.c420 = Constraint(expr=   m.x504 <= -0.242105263157895)
...
m.c433 = Constraint(expr=   m.x521 <= -0.105263157894737)

m.c434 = Constraint(expr=   m.x522 <= -0.105263157894737)

m.c435 = Constraint(expr=   m.x523 <= -0.105263157894737)

m.c436 = Constraint(expr=   m.x524 <= -0.105263157894737)

m.c437 = Constraint(expr=   m.x525 <= -0.0842105263157895)

m.c438 = Constraint(expr=   m.x526 <= -0.0842105263157895)

m.c439 = Constraint(expr=   m.x527 <= -0.0842105263157895)

m.c440 = Constraint(expr=   m.x528 <= -0.0842105263157895)

m.c441 = Constraint(expr=   m.x529 <= -0.136842105263158)

m.c442 = Constraint(expr=   m.x530 <= -0.136842105263158)

m.c443 = Constraint(expr=   m.x531 <= -0.136842105263158)

m.c444 = Constraint(expr=   m.x532 <= -0.136842105263158)

m.c445 = Constraint(expr=   m.x533 <= -0.4)

m.c446 = Constraint(expr=   m.x534 <= -0.4)

m.c447 = Constraint(expr=   m.x535 <= -0.4)

m.c448 = Constraint(expr=   m.x536 <= -0.4)
