...
m.x97 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x98 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x99 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x100 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x101 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x102 = Var(within=Reals,bounds=(3,12),initialize=3)
m.x103 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x104 = Var(within=Reals,bounds=(3,12),initialize=3)
m.x105 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x106 = Var(within=Reals,bounds=(3,12),initialize=3)
m.x107 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x108 = Var(within=Reals,bounds=(3,12),initialize=3)
...
m.x116 = Var(within=Reals,bounds=(1.5,6),initialize=1.5)
m.x117 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x118 = Var(within=Reals,bounds=(1.5,6),initialize=1.5)
...
m.c77 = Constraint(expr= - 0.5*m.x94 - 0.125*m.x96 <= -2)

m.c78 = Constraint(expr= - 0.125*m.x94 - 0.5*m.x96 <= -2)

m.c79 = Constraint(expr= - 0.5*m.x95 - 0.125*m.x97 <= -2)

m.c80 = Constraint(expr= - 0.125*m.x95 - 0.5*m.x97 <= -2)

m.c81 = Constraint(expr= - 0.5*m.x98 - 0.125*m.x100 <= -2)

m.c82 = Constraint(expr= - 0.125*m.x98 - 0.5*m.x100 <= -2)

m.c83 = Constraint(expr= - 0.333333*m.x102 - 0.083333*m.x104 <= -2)

m.c84 = Constraint(expr= - 0.083333*m.x102 - 0.333333*m.x104 <= -2)

m.c85 = Constraint(expr= - 0.333333*m.x106 - 0.083333*m.x108 <= -2)

m.c86 = Constraint(expr= - 0.083333*m.x106 - 0.333333*m.x108 <= -2)

m.c87 = Constraint(expr= - 0.666667*m.x110 - 0.166667*m.x112 <= -2)

m.c88 = Constraint(expr= - 0.166667*m.x110 - 0.666667*m.x112 <= -2)

m.c89 = Constraint(expr= - 0.666667*m.x114 - 0.166667*m.x116 <= -2)

m.c90 = Constraint(expr= - 0.166667*m.x114 - 0.666667*m.x116 <= -2)

m.c91 = Constraint(expr= - 0.666667*m.x118 - 0.166667*m.x120 <= -2)

m.c92 = Constraint(expr= - 0.166667*m.x118 - 0.666667*m.x120 <= -2)

m.c93 = Constraint(expr= - 0.666667*m.x122 - 0.166667*m.x124 <= -2)

m.c94 = Constraint(expr= - 0.166667*m.x122 - 0.666667*m.x124 <= -2)
