...
m.x94 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x95 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x96 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x97 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x98 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x99 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x100 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x101 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x102 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x103 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x104 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x105 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x106 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x107 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x108 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x109 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x110 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x111 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x112 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x113 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x114 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x115 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x116 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x117 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x118 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x119 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x120 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x121 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x122 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x123 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x124 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
...
m.c77 = Constraint(expr= - 0.433013*m.x94 - 0.144338*m.x96 <= -2)

m.c78 = Constraint(expr= - 0.144338*m.x94 - 0.433013*m.x96 <= -2)

m.c79 = Constraint(expr= - 0.433013*m.x95 - 0.144338*m.x97 <= -2)

m.c80 = Constraint(expr= - 0.144338*m.x95 - 0.433013*m.x97 <= -2)

m.c81 = Constraint(expr= - 0.433013*m.x98 - 0.144338*m.x100 <= -2)

m.c82 = Constraint(expr= - 0.144338*m.x98 - 0.433013*m.x100 <= -2)

m.c83 = Constraint(expr= - 0.288675*m.x102 - 0.096225*m.x104 <= -2)

m.c84 = Constraint(expr= - 0.096225*m.x102 - 0.288675*m.x104 <= -2)

m.c85 = Constraint(expr= - 0.288675*m.x106 - 0.096225*m.x108 <= -2)

m.c86 = Constraint(expr= - 0.096225*m.x106 - 0.288675*m.x108 <= -2)

m.c87 = Constraint(expr= - 0.577334*m.x110 - 0.192456*m.x112 <= -2)

m.c88 = Constraint(expr= - 0.192448*m.x110 - 0.577356*m.x112 <= -2)

m.c89 = Constraint(expr= - 0.577334*m.x114 - 0.192456*m.x116 <= -2)

m.c90 = Constraint(expr= - 0.192448*m.x114 - 0.577356*m.x116 <= -2)

m.c91 = Constraint(expr= - 0.577334*m.x118 - 0.192456*m.x120 <= -2)

m.c92 = Constraint(expr= - 0.192448*m.x118 - 0.577356*m.x120 <= -2)

m.c93 = Constraint(expr= - 0.577334*m.x122 - 0.192456*m.x124 <= -2)

m.c94 = Constraint(expr= - 0.192448*m.x122 - 0.577356*m.x124 <= -2)
