...
m.x58 = Var(within=Reals,bounds=(2.8,7.4833),initialize=2.8)
m.x59 = Var(within=Reals,bounds=(2,6.3246),initialize=2)
m.x60 = Var(within=Reals,bounds=(1.8708,5),initialize=1.8708)
m.x61 = Var(within=Reals,bounds=(1.5811,5),initialize=1.5811)
m.x62 = Var(within=Reals,bounds=(1.8,6),initialize=1.8)
m.x63 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x64 = Var(within=Reals,bounds=(1.5,5),initialize=1.5)
m.x65 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x66 = Var(within=Reals,bounds=(1.2247,4.899),initialize=1.2247)
m.x67 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x68 = Var(within=Reals,bounds=(1.2247,4.899),initialize=1.2247)
m.x69 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x70 = Var(within=Reals,bounds=(2,6.3246),initialize=2)
m.x71 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x72 = Var(within=Reals,bounds=(1.5811,5),initialize=1.5811)
m.x73 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x74 = Var(within=Reals,bounds=(5,10),initialize=5)
m.x75 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x76 = Var(within=Reals,bounds=(2.5,5),initialize=2.5)
m.x77 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x78 = Var(within=Reals,bounds=(5,10),initialize=5)
m.x79 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x80 = Var(within=Reals,bounds=(2.5,5),initialize=2.5)
...
m.c48 = Constraint(expr= - 0.133631*m.x58 - 0.534521*m.x60 <= -2)

m.c49 = Constraint(expr= - 0.5*m.x59 - 0.2*m.x61 <= -2)

m.c50 = Constraint(expr= - 0.158113*m.x59 - 0.63246*m.x61 <= -2)

m.c51 = Constraint(expr= - 0.555556*m.x62 - 0.2*m.x64 <= -2)

m.c52 = Constraint(expr= - 0.166667*m.x62 - 0.666667*m.x64 <= -2)

m.c53 = Constraint(expr= - 0.816526*m.x66 - 0.204117*m.x68 <= -2)

m.c54 = Constraint(expr= - 0.204123*m.x66 - 0.8165*m.x68 <= -2)

m.c55 = Constraint(expr= - 0.5*m.x70 - 0.2*m.x72 <= -2)

m.c56 = Constraint(expr= - 0.158113*m.x70 - 0.63246*m.x72 <= -2)

m.c57 = Constraint(expr= - 0.2*m.x74 - 0.2*m.x76 <= -2)

m.c58 = Constraint(expr= - 0.1*m.x74 - 0.4*m.x76 <= -2)

m.c59 = Constraint(expr= - 0.2*m.x78 - 0.2*m.x80 <= -2)

m.c60 = Constraint(expr= - 0.1*m.x78 - 0.4*m.x80 <= -2)
