...
m.x58 = Var(within=Reals,bounds=(2.8,8.3666),initialize=2.8)
m.x59 = Var(within=Reals,bounds=(2,7.0711),initialize=2)
m.x60 = Var(within=Reals,bounds=(1.6733,5),initialize=1.6733)
m.x61 = Var(within=Reals,bounds=(1.4142,5),initialize=1.4142)
m.x62 = Var(within=Reals,bounds=(1.8,6.7082),initialize=1.8)
m.x63 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x64 = Var(within=Reals,bounds=(1.3416,5),initialize=1.3416)
m.x65 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x66 = Var(within=Reals,bounds=(1.2,5.4772),initialize=1.2)
m.x67 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x68 = Var(within=Reals,bounds=(1.0954,5),initialize=1.0954)
m.x69 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x70 = Var(within=Reals,bounds=(2,7.0711),initialize=2)
m.x71 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x72 = Var(within=Reals,bounds=(1.4142,5),initialize=1.4142)
m.x73 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x74 = Var(within=Reals,bounds=(5,11.1803),initialize=5)
m.x75 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x76 = Var(within=Reals,bounds=(2.2361,5),initialize=2.2361)
m.x77 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x78 = Var(within=Reals,bounds=(5,11.1803),initialize=5)
m.x79 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x80 = Var(within=Reals,bounds=(2.2361,5),initialize=2.2361)
...
m.c48 = Constraint(expr= - 0.119523*m.x58 - 0.597614*m.x60 <= -2)

m.c49 = Constraint(expr= - 0.5*m.x59 - 0.2*m.x61 <= -2)

m.c50 = Constraint(expr= - 0.141421*m.x59 - 0.70711*m.x61 <= -2)

m.c51 = Constraint(expr= - 0.555556*m.x62 - 0.2*m.x64 <= -2)

m.c52 = Constraint(expr= - 0.149071*m.x62 - 0.745356*m.x64 <= -2)

m.c53 = Constraint(expr= - 0.833333*m.x66 - 0.2*m.x68 <= -2)

m.c54 = Constraint(expr= - 0.182575*m.x66 - 0.912867*m.x68 <= -2)

m.c55 = Constraint(expr= - 0.5*m.x70 - 0.2*m.x72 <= -2)

m.c56 = Constraint(expr= - 0.141421*m.x70 - 0.70711*m.x72 <= -2)

m.c57 = Constraint(expr= - 0.2*m.x74 - 0.2*m.x76 <= -2)

m.c58 = Constraint(expr= - 0.089443*m.x74 - 0.447212*m.x76 <= -2)

m.c59 = Constraint(expr= - 0.2*m.x78 - 0.2*m.x80 <= -2)

m.c60 = Constraint(expr= - 0.089443*m.x78 - 0.447212*m.x80 <= -2)
