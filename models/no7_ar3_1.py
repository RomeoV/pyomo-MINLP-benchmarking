...
m.x67 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x68 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x69 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x70 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
...
m.x76 = Var(within=Reals,bounds=(3.4641,8.54),initialize=3.4641)
m.x77 = Var(within=Reals,bounds=(4.2155,10.3923),initialize=4.2155)
...
m.x87 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
...
m.c47 = Constraint(expr= - 0.433013*m.x66 - 0.144338*m.x69 <= -2)

m.c48 = Constraint(expr= - 0.144338*m.x66 - 0.433013*m.x69 <= -2)

m.c49 = Constraint(expr= - 0.433013*m.x67 - 0.144338*m.x70 <= -2)

m.c50 = Constraint(expr= - 0.144338*m.x67 - 0.433013*m.x70 <= -2)

m.c51 = Constraint(expr= - 0.433013*m.x72 - 0.144338*m.x74 <= -2)

m.c52 = Constraint(expr= - 0.144338*m.x72 - 0.433013*m.x74 <= -2)

m.c53 = Constraint(expr= - 0.288675*m.x76 - 0.096225*m.x77 <= -2)

m.c54 = Constraint(expr= - 0.117096*m.x76 - 0.237222*m.x77 <= -2)

m.c55 = Constraint(expr= - 0.577334*m.x78 - 0.192456*m.x80 <= -2)

m.c56 = Constraint(expr= - 0.192448*m.x78 - 0.577356*m.x80 <= -2)

m.c57 = Constraint(expr= - 0.577334*m.x82 - 0.192456*m.x84 <= -2)

m.c58 = Constraint(expr= - 0.192448*m.x82 - 0.577356*m.x84 <= -2)

m.c59 = Constraint(expr= - 0.577334*m.x86 - 0.192456*m.x87 <= -2)

m.c60 = Constraint(expr= - 0.192448*m.x86 - 0.577356*m.x87 <= -2)
