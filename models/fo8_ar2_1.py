...
m.x77 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x78 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x79 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x80 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x81 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x82 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x83 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x84 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x85 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x86 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x87 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x88 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x89 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x90 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x91 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x92 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x93 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x94 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x95 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x96 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x97 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x98 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x99 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x100 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x101 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x102 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
...
m.c61 = Constraint(expr= - 0.353557*m.x76 - 0.176775*m.x78 <= -2)

m.c62 = Constraint(expr= - 0.176775*m.x76 - 0.353556*m.x78 <= -2)

m.c63 = Constraint(expr= - 0.353557*m.x77 - 0.176775*m.x79 <= -2)

m.c64 = Constraint(expr= - 0.176775*m.x77 - 0.353556*m.x79 <= -2)

m.c65 = Constraint(expr= - 0.353557*m.x80 - 0.176775*m.x82 <= -2)

m.c66 = Constraint(expr= - 0.176775*m.x80 - 0.353556*m.x82 <= -2)

m.c67 = Constraint(expr= - 0.235705*m.x84 - 0.11785*m.x86 <= -2)

m.c68 = Constraint(expr= - 0.117851*m.x84 - 0.235703*m.x86 <= -2)

m.c69 = Constraint(expr= - 0.235705*m.x88 - 0.11785*m.x90 <= -2)

m.c70 = Constraint(expr= - 0.117851*m.x88 - 0.235703*m.x90 <= -2)

m.c71 = Constraint(expr= - 0.471409*m.x92 - 0.2357*m.x94 <= -2)

m.c72 = Constraint(expr= - 0.235705*m.x92 - 0.4714*m.x94 <= -2)

m.c73 = Constraint(expr= - 0.471409*m.x96 - 0.2357*m.x98 <= -2)

m.c74 = Constraint(expr= - 0.235705*m.x96 - 0.4714*m.x98 <= -2)

m.c75 = Constraint(expr= - 0.471409*m.x100 - 0.2357*m.x102 <= -2)

m.c76 = Constraint(expr= - 0.235705*m.x100 - 0.4714*m.x102 <= -2)
