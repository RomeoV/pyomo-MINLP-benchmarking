...
m.x94 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x95 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x96 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x97 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x98 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x99 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x100 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x101 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x102 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x103 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x104 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x105 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x106 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x107 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x108 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x109 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x110 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x111 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x112 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x113 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x114 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x115 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x116 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x117 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x118 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x119 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x120 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x121 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x122 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
m.x123 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x124 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
...
m.c77 = Constraint(expr= - 0.353557*m.x94 - 0.176775*m.x96 <= -2)

m.c78 = Constraint(expr= - 0.176775*m.x94 - 0.353556*m.x96 <= -2)

m.c79 = Constraint(expr= - 0.353557*m.x95 - 0.176775*m.x97 <= -2)

m.c80 = Constraint(expr= - 0.176775*m.x95 - 0.353556*m.x97 <= -2)

m.c81 = Constraint(expr= - 0.353557*m.x98 - 0.176775*m.x100 <= -2)

m.c82 = Constraint(expr= - 0.176775*m.x98 - 0.353556*m.x100 <= -2)

m.c83 = Constraint(expr= - 0.235705*m.x102 - 0.11785*m.x104 <= -2)

m.c84 = Constraint(expr= - 0.117851*m.x102 - 0.235703*m.x104 <= -2)

m.c85 = Constraint(expr= - 0.235705*m.x106 - 0.11785*m.x108 <= -2)

m.c86 = Constraint(expr= - 0.117851*m.x106 - 0.235703*m.x108 <= -2)

m.c87 = Constraint(expr= - 0.471409*m.x110 - 0.2357*m.x112 <= -2)

m.c88 = Constraint(expr= - 0.235705*m.x110 - 0.4714*m.x112 <= -2)

m.c89 = Constraint(expr= - 0.471409*m.x114 - 0.2357*m.x116 <= -2)

m.c90 = Constraint(expr= - 0.235705*m.x114 - 0.4714*m.x116 <= -2)

m.c91 = Constraint(expr= - 0.471409*m.x118 - 0.2357*m.x120 <= -2)

m.c92 = Constraint(expr= - 0.235705*m.x118 - 0.4714*m.x120 <= -2)

m.c93 = Constraint(expr= - 0.471409*m.x122 - 0.2357*m.x124 <= -2)

m.c94 = Constraint(expr= - 0.235705*m.x122 - 0.4714*m.x124 <= -2)
