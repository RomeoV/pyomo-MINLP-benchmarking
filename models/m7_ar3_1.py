#  MINLP written by GAMS Convert at 05/10/19 14:22:32
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        270        2        2      266        0        0        0        0
...
m.x58 = Var(within=Reals,bounds=(2.8,6.4807),initialize=2.8)
m.x59 = Var(within=Reals,bounds=(2,5.4772),initialize=2)
m.x60 = Var(within=Reals,bounds=(2.1602,5),initialize=2.1602)
m.x61 = Var(within=Reals,bounds=(1.8257,5),initialize=1.8257)
m.x62 = Var(within=Reals,bounds=(1.8,5.1962),initialize=1.8)
m.x63 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x64 = Var(within=Reals,bounds=(1.7321,5),initialize=1.7321)
m.x65 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x66 = Var(within=Reals,bounds=(1.4142,4.2426),initialize=1.4142)
m.x67 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x68 = Var(within=Reals,bounds=(1.4142,4.2426),initialize=1.4142)
m.x69 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x70 = Var(within=Reals,bounds=(2,5.4772),initialize=2)
m.x71 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x72 = Var(within=Reals,bounds=(1.8257,5),initialize=1.8257)
m.x73 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x74 = Var(within=Reals,bounds=(5,8.6603),initialize=5)
m.x75 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x76 = Var(within=Reals,bounds=(2.8868,5),initialize=2.8868)
m.x77 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x78 = Var(within=Reals,bounds=(5,8.6603),initialize=5)
m.x79 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x80 = Var(within=Reals,bounds=(2.8868,5),initialize=2.8868)
...
m.c48 = Constraint(expr= - 0.154304*m.x58 - 0.462907*m.x60 <= -2)

m.c49 = Constraint(expr= - 0.5*m.x59 - 0.2*m.x61 <= -2)

m.c50 = Constraint(expr= - 0.182575*m.x59 - 0.54772*m.x61 <= -2)

m.c51 = Constraint(expr= - 0.555556*m.x62 - 0.2*m.x64 <= -2)

m.c52 = Constraint(expr= - 0.192448*m.x62 - 0.577356*m.x64 <= -2)

m.c53 = Constraint(expr= - 0.707114*m.x66 - 0.2357*m.x68 <= -2)

m.c54 = Constraint(expr= - 0.235705*m.x66 - 0.7071*m.x68 <= -2)

m.c55 = Constraint(expr= - 0.5*m.x70 - 0.2*m.x72 <= -2)

m.c56 = Constraint(expr= - 0.182575*m.x70 - 0.54772*m.x72 <= -2)

m.c57 = Constraint(expr= - 0.2*m.x74 - 0.2*m.x76 <= -2)

m.c58 = Constraint(expr= - 0.115469*m.x74 - 0.346412*m.x76 <= -2)

m.c59 = Constraint(expr= - 0.2*m.x78 - 0.2*m.x80 <= -2)

m.c60 = Constraint(expr= - 0.115469*m.x78 - 0.346412*m.x80 <= -2)
