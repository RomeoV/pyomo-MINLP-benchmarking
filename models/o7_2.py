...
m.obj = Objective(expr=   5*m.x48 + 5*m.x49 + m.x54 + m.x55 + 3*m.x58 + 3*m.x59 + m.x64 + m.x65 + 2*m.x66 + 2*m.x67
                        + m.x72 + m.x73 + 4*m.x74 + 4*m.x75 + 4*m.x76 + 4*m.x77 + 2*m.x82 + 2*m.x83 + m.x84 + m.x85
                       , sense=minimize)
