...
#  Equation counts
#      Total        E        G        L        N        X        C        B
#       1075      173      268      634        0        0        0        0
#  
#  Variable counts
#                   x        b        i      s1s      s2s       sc       si
#      Total     cont   binary  integer     sos1     sos2    scont     sint
#        511      303      208        0        0        0        0        0
#  FX      0        0        0        0        0        0        0        0
#  
#  Nonzero counts
#      Total    const       NL      DLL
...
m.obj = Objective(expr= - 20*m.x2 - 17*m.x3 - 20*m.x12 - 21*m.x13 - 18*m.x20 - 20*m.x21 - 16*m.x44 - 19*m.x45 + 26*m.x52
                        ...
                        - 2*m.x324 - m.x325 - 10*m.x358 - 5*m.x359 - 5*m.x360 - 5*m.x361 + 80*m.x374 + 130*m.x375
                        + 110*m.x376 + 120*m.x377 + 110*m.x378 + 130*m.x379 + 80*m.x380 + 90*m.x381 + 285*m.x382
                        + 390*m.x383 + 290*m.x384 + 405*m.x385 + 280*m.x386 + 400*m.x387 + 290*m.x388 + 300*m.x389
                        + 350*m.x390 + 250*m.x391 - 5*m.b432 - 4*m.b433 - 8*m.b434 - 7*m.b435 - 6*m.b436 - 9*m.b437
                        - 10*m.b438 - 9*m.b439 - 6*m.b440 - 10*m.b441 - 7*m.b442 - 7*m.b443 - 4*m.b444 - 3*m.b445
                        - 5*m.b446 - 6*m.b447 - 2*m.b448 - 5*m.b449 - 4*m.b450 - 7*m.b451 - 3*m.b452 - 9*m.b453
                        - 7*m.b454 - 2*m.b455 - 3*m.b456 - m.b457 - 2*m.b458 - 6*m.b459 - 4*m.b460 - 8*m.b461 - 2*m.b462
                        - 5*m.b463 - 3*m.b464 - 4*m.b465 - 5*m.b466 - 7*m.b467 - 2*m.b468 - 8*m.b469 - m.b470 - 4*m.b471
                       , sense=maximize)
...
m.c690 = Constraint(expr=-log(1 + m.x304) + m.x308 + m.b392 <= 1)

m.c691 = Constraint(expr=-log(1 + m.x305) + m.x309 + m.b393 <= 1)

m.c692 = Constraint(expr=   m.x304 - 40*m.b392 <= 0)

m.c693 = Constraint(expr=   m.x305 - 40*m.b393 <= 0)

m.c694 = Constraint(expr=   m.x308 - 3.71357206670431*m.b392 <= 0)

m.c695 = Constraint(expr=   m.x309 - 3.71357206670431*m.b393 <= 0)

m.c696 = Constraint(expr=-1.2*log(1 + m.x306) + m.x310 + m.b394 <= 1)

m.c697 = Constraint(expr=-1.2*log(1 + m.x307) + m.x311 + m.b395 <= 1)

m.c698 = Constraint(expr=   m.x306 - 40*m.b394 <= 0)

m.c699 = Constraint(expr=   m.x307 - 40*m.b395 <= 0)

m.c700 = Constraint(expr=   m.x310 - 4.45628648004517*m.b394 <= 0)

m.c701 = Constraint(expr=   m.x311 - 4.45628648004517*m.b395 <= 0)

m.c702 = Constraint(expr= - 0.75*m.x318 + m.x326 + m.b396 <= 1)

m.c703 = Constraint(expr= - 0.75*m.x319 + m.x327 + m.b397 <= 1)

m.c704 = Constraint(expr= - 0.75*m.x318 + m.x326 - m.b396 >= -1)

m.c705 = Constraint(expr= - 0.75*m.x319 + m.x327 - m.b397 >= -1)

m.c706 = Constraint(expr=   m.x318 - 4.45628648004517*m.b396 <= 0)

m.c707 = Constraint(expr=   m.x319 - 4.45628648004517*m.b397 <= 0)

m.c708 = Constraint(expr=   m.x326 - 3.34221486003388*m.b396 <= 0)

m.c709 = Constraint(expr=   m.x327 - 3.34221486003388*m.b397 <= 0)

m.c710 = Constraint(expr=-1.5*log(1 + m.x320) + m.x328 + m.b398 <= 1)

m.c711 = Constraint(expr=-1.5*log(1 + m.x321) + m.x329 + m.b399 <= 1)

m.c712 = Constraint(expr=   m.x320 - 4.45628648004517*m.b398 <= 0)

m.c713 = Constraint(expr=   m.x321 - 4.45628648004517*m.b399 <= 0)

m.c714 = Constraint(expr=   m.x328 - 2.54515263975353*m.b398 <= 0)

m.c715 = Constraint(expr=   m.x329 - 2.54515263975353*m.b399 <= 0)

m.c716 = Constraint(expr= - m.x322 + m.x330 + m.b400 <= 1)

m.c717 = Constraint(expr= - m.x323 + m.x331 + m.b401 <= 1)

m.c718 = Constraint(expr= - m.x322 + m.x330 - m.b400 >= -1)

m.c719 = Constraint(expr= - m.x323 + m.x331 - m.b401 >= -1)

m.c720 = Constraint(expr= - 0.5*m.x324 + m.x330 + m.b400 <= 1)

m.c721 = Constraint(expr= - 0.5*m.x325 + m.x331 + m.b401 <= 1)

m.c722 = Constraint(expr= - 0.5*m.x324 + m.x330 - m.b400 >= -1)

m.c723 = Constraint(expr= - 0.5*m.x325 + m.x331 - m.b401 >= -1)

m.c724 = Constraint(expr=   m.x322 - 4.45628648004517*m.b400 <= 0)

m.c725 = Constraint(expr=   m.x323 - 4.45628648004517*m.b401 <= 0)

m.c726 = Constraint(expr=   m.x324 - 30*m.b400 <= 0)

m.c727 = Constraint(expr=   m.x325 - 30*m.b401 <= 0)

m.c728 = Constraint(expr=   m.x330 - 15*m.b400 <= 0)

m.c729 = Constraint(expr=   m.x331 - 15*m.b401 <= 0)

m.c730 = Constraint(expr=-1.25*log(1 + m.x332) + m.x342 + m.b402 <= 1)

m.c731 = Constraint(expr=-1.25*log(1 + m.x333) + m.x343 + m.b403 <= 1)

m.c732 = Constraint(expr=   m.x332 - 3.34221486003388*m.b402 <= 0)

m.c733 = Constraint(expr=   m.x333 - 3.34221486003388*m.b403 <= 0)

m.c734 = Constraint(expr=   m.x342 - 1.83548069293539*m.b402 <= 0)

m.c735 = Constraint(expr=   m.x343 - 1.83548069293539*m.b403 <= 0)

m.c736 = Constraint(expr=-0.9*log(1 + m.x334) + m.x344 + m.b404 <= 1)

m.c737 = Constraint(expr=-0.9*log(1 + m.x335) + m.x345 + m.b405 <= 1)

m.c738 = Constraint(expr=   m.x334 - 3.34221486003388*m.b404 <= 0)

m.c739 = Constraint(expr=   m.x335 - 3.34221486003388*m.b405 <= 0)

m.c740 = Constraint(expr=   m.x344 - 1.32154609891348*m.b404 <= 0)

m.c741 = Constraint(expr=   m.x345 - 1.32154609891348*m.b405 <= 0)

m.c742 = Constraint(expr=-log(1 + m.x328) + m.x346 + m.b406 <= 1)

m.c743 = Constraint(expr=-log(1 + m.x329) + m.x347 + m.b407 <= 1)

m.c744 = Constraint(expr=   m.x328 - 2.54515263975353*m.b406 <= 0)

m.c745 = Constraint(expr=   m.x329 - 2.54515263975353*m.b407 <= 0)

m.c746 = Constraint(expr=   m.x346 - 1.26558121681553*m.b406 <= 0)

m.c747 = Constraint(expr=   m.x347 - 1.26558121681553*m.b407 <= 0)

m.c748 = Constraint(expr= - 0.9*m.x336 + m.x348 + m.b408 <= 1)

m.c749 = Constraint(expr= - 0.9*m.x337 + m.x349 + m.b409 <= 1)

m.c750 = Constraint(expr= - 0.9*m.x336 + m.x348 - m.b408 >= -1)

m.c751 = Constraint(expr= - 0.9*m.x337 + m.x349 - m.b409 >= -1)

m.c752 = Constraint(expr=   m.x336 - 15*m.b408 <= 0)

m.c753 = Constraint(expr=   m.x337 - 15*m.b409 <= 0)

m.c754 = Constraint(expr=   m.x348 - 13.5*m.b408 <= 0)

m.c755 = Constraint(expr=   m.x349 - 13.5*m.b409 <= 0)

m.c756 = Constraint(expr= - 0.6*m.x338 + m.x350 + m.b410 <= 1)

m.c757 = Constraint(expr= - 0.6*m.x339 + m.x351 + m.b411 <= 1)

m.c758 = Constraint(expr= - 0.6*m.x338 + m.x350 - m.b410 >= -1)

m.c759 = Constraint(expr= - 0.6*m.x339 + m.x351 - m.b411 >= -1)

m.c760 = Constraint(expr=   m.x338 - 15*m.b410 <= 0)

m.c761 = Constraint(expr=   m.x339 - 15*m.b411 <= 0)

m.c762 = Constraint(expr=   m.x350 - 9*m.b410 <= 0)

m.c763 = Constraint(expr=   m.x351 - 9*m.b411 <= 0)

m.c764 = Constraint(expr=-1.1*log(1 + m.x340) + m.x352 + m.b412 <= 1)

m.c765 = Constraint(expr=-1.1*log(1 + m.x341) + m.x353 + m.b413 <= 1)

m.c766 = Constraint(expr=   m.x340 - 15*m.b412 <= 0)

m.c767 = Constraint(expr=   m.x341 - 15*m.b413 <= 0)

m.c768 = Constraint(expr=   m.x352 - 3.04984759446376*m.b412 <= 0)

m.c769 = Constraint(expr=   m.x353 - 3.04984759446376*m.b413 <= 0)

m.c770 = Constraint(expr= - 0.9*m.x342 + m.x374 + m.b414 <= 1)

m.c771 = Constraint(expr= - 0.9*m.x343 + m.x375 + m.b415 <= 1)

m.c772 = Constraint(expr= - 0.9*m.x342 + m.x374 - m.b414 >= -1)

m.c773 = Constraint(expr= - 0.9*m.x343 + m.x375 - m.b415 >= -1)

m.c774 = Constraint(expr= - m.x358 + m.x374 + m.b414 <= 1)

m.c775 = Constraint(expr= - m.x359 + m.x375 + m.b415 <= 1)

m.c776 = Constraint(expr= - m.x358 + m.x374 - m.b414 >= -1)

m.c777 = Constraint(expr= - m.x359 + m.x375 - m.b415 >= -1)

m.c778 = Constraint(expr=   m.x342 - 1.83548069293539*m.b414 <= 0)

m.c779 = Constraint(expr=   m.x343 - 1.83548069293539*m.b415 <= 0)

m.c780 = Constraint(expr=   m.x358 - 20*m.b414 <= 0)

m.c781 = Constraint(expr=   m.x359 - 20*m.b415 <= 0)

m.c782 = Constraint(expr=   m.x374 - 20*m.b414 <= 0)

m.c783 = Constraint(expr=   m.x375 - 20*m.b415 <= 0)

m.c784 = Constraint(expr=-log(1 + m.x344) + m.x376 + m.b416 <= 1)

m.c785 = Constraint(expr=-log(1 + m.x345) + m.x377 + m.b417 <= 1)

m.c786 = Constraint(expr=   m.x344 - 1.32154609891348*m.b416 <= 0)

m.c787 = Constraint(expr=   m.x345 - 1.32154609891348*m.b417 <= 0)

m.c788 = Constraint(expr=   m.x376 - 0.842233385663186*m.b416 <= 0)

m.c789 = Constraint(expr=   m.x377 - 0.842233385663186*m.b417 <= 0)

m.c790 = Constraint(expr=-0.7*log(1 + m.x354) + m.x378 + m.b418 <= 1)

m.c791 = Constraint(expr=-0.7*log(1 + m.x355) + m.x379 + m.b419 <= 1)

m.c792 = Constraint(expr=   m.x354 - 1.26558121681553*m.b418 <= 0)

m.c793 = Constraint(expr=   m.x355 - 1.26558121681553*m.b419 <= 0)

m.c794 = Constraint(expr=   m.x378 - 0.572481933717686*m.b418 <= 0)

m.c795 = Constraint(expr=   m.x379 - 0.572481933717686*m.b419 <= 0)

m.c796 = Constraint(expr=-0.65*log(1 + m.x356) + m.x380 + m.b420 <= 1)

m.c797 = Constraint(expr=-0.65*log(1 + m.x357) + m.x381 + m.b421 <= 1)

m.c798 = Constraint(expr=-0.65*log(1 + m.x362) + m.x380 + m.b420 <= 1)

m.c799 = Constraint(expr=-0.65*log(1 + m.x363) + m.x381 + m.b421 <= 1)

m.c800 = Constraint(expr=   m.x356 - 1.26558121681553*m.b420 <= 0)

m.c801 = Constraint(expr=   m.x357 - 1.26558121681553*m.b421 <= 0)

m.c802 = Constraint(expr=   m.x362 - 33.5*m.b420 <= 0)

m.c803 = Constraint(expr=   m.x363 - 33.5*m.b421 <= 0)

m.c804 = Constraint(expr=   m.x380 - 2.30162356062425*m.b420 <= 0)

m.c805 = Constraint(expr=   m.x381 - 2.30162356062425*m.b421 <= 0)

m.c806 = Constraint(expr= - m.x364 + m.x382 + m.b422 <= 1)

m.c807 = Constraint(expr= - m.x365 + m.x383 + m.b423 <= 1)

m.c808 = Constraint(expr= - m.x364 + m.x382 - m.b422 >= -1)

m.c809 = Constraint(expr= - m.x365 + m.x383 - m.b423 >= -1)

m.c810 = Constraint(expr=   m.x364 - 9*m.b422 <= 0)

m.c811 = Constraint(expr=   m.x365 - 9*m.b423 <= 0)

m.c812 = Constraint(expr=   m.x382 - 9*m.b422 <= 0)

m.c813 = Constraint(expr=   m.x383 - 9*m.b423 <= 0)

m.c814 = Constraint(expr= - m.x366 + m.x384 + m.b424 <= 1)

m.c815 = Constraint(expr= - m.x367 + m.x385 + m.b425 <= 1)

m.c816 = Constraint(expr= - m.x366 + m.x384 - m.b424 >= -1)

m.c817 = Constraint(expr= - m.x367 + m.x385 - m.b425 >= -1)

m.c818 = Constraint(expr=   m.x366 - 9*m.b424 <= 0)

m.c819 = Constraint(expr=   m.x367 - 9*m.b425 <= 0)

m.c820 = Constraint(expr=   m.x384 - 9*m.b424 <= 0)

m.c821 = Constraint(expr=   m.x385 - 9*m.b425 <= 0)

m.c822 = Constraint(expr=-0.75*log(1 + m.x368) + m.x386 + m.b426 <= 1)

m.c823 = Constraint(expr=-0.75*log(1 + m.x369) + m.x387 + m.b427 <= 1)

m.c824 = Constraint(expr=   m.x368 - 3.04984759446376*m.b426 <= 0)

m.c825 = Constraint(expr=   m.x369 - 3.04984759446376*m.b427 <= 0)

m.c826 = Constraint(expr=   m.x386 - 1.04900943706034*m.b426 <= 0)

m.c827 = Constraint(expr=   m.x387 - 1.04900943706034*m.b427 <= 0)

m.c828 = Constraint(expr=-0.8*log(1 + m.x370) + m.x388 + m.b428 <= 1)

m.c829 = Constraint(expr=-0.8*log(1 + m.x371) + m.x389 + m.b429 <= 1)

m.c830 = Constraint(expr=   m.x370 - 3.04984759446376*m.b428 <= 0)

m.c831 = Constraint(expr=   m.x371 - 3.04984759446376*m.b429 <= 0)

m.c832 = Constraint(expr=   m.x388 - 1.11894339953103*m.b428 <= 0)

m.c833 = Constraint(expr=   m.x389 - 1.11894339953103*m.b429 <= 0)

m.c834 = Constraint(expr=-0.85*log(1 + m.x372) + m.x390 + m.b430 <= 1)

m.c835 = Constraint(expr=-0.85*log(1 + m.x373) + m.x391 + m.b431 <= 1)

m.c836 = Constraint(expr=   m.x372 - 3.04984759446376*m.b430 <= 0)

m.c837 = Constraint(expr=   m.x373 - 3.04984759446376*m.b431 <= 0)

m.c838 = Constraint(expr=   m.x390 - 1.18887736200171*m.b430 <= 0)

m.c839 = Constraint(expr=   m.x391 - 1.18887736200171*m.b431 <= 0)

m.c840 = Constraint(expr=   5*m.b432 + m.x472 <= 0)

m.c841 = Constraint(expr=   4*m.b433 + m.x473 <= 0)

m.c842 = Constraint(expr=   8*m.b434 + m.x474 <= 0)

m.c843 = Constraint(expr=   7*m.b435 + m.x475 <= 0)

m.c844 = Constraint(expr=   6*m.b436 + m.x476 <= 0)

m.c845 = Constraint(expr=   9*m.b437 + m.x477 <= 0)

m.c846 = Constraint(expr=   10*m.b438 + m.x478 <= 0)

m.c847 = Constraint(expr=   9*m.b439 + m.x479 <= 0)

m.c848 = Constraint(expr=   6*m.b440 + m.x480 <= 0)

m.c849 = Constraint(expr=   10*m.b441 + m.x481 <= 0)

m.c850 = Constraint(expr=   7*m.b442 + m.x482 <= 0)

m.c851 = Constraint(expr=   7*m.b443 + m.x483 <= 0)

m.c852 = Constraint(expr=   4*m.b444 + m.x484 <= 0)

m.c853 = Constraint(expr=   3*m.b445 + m.x485 <= 0)

m.c854 = Constraint(expr=   5*m.b446 + m.x486 <= 0)

m.c855 = Constraint(expr=   6*m.b447 + m.x487 <= 0)

m.c856 = Constraint(expr=   2*m.b448 + m.x488 <= 0)

m.c857 = Constraint(expr=   5*m.b449 + m.x489 <= 0)

m.c858 = Constraint(expr=   4*m.b450 + m.x490 <= 0)

m.c859 = Constraint(expr=   7*m.b451 + m.x491 <= 0)

m.c860 = Constraint(expr=   3*m.b452 + m.x492 <= 0)

m.c861 = Constraint(expr=   9*m.b453 + m.x493 <= 0)

m.c862 = Constraint(expr=   7*m.b454 + m.x494 <= 0)

m.c863 = Constraint(expr=   2*m.b455 + m.x495 <= 0)

m.c864 = Constraint(expr=   3*m.b456 + m.x496 <= 0)

m.c865 = Constraint(expr=   m.b457 + m.x497 <= 0)

m.c866 = Constraint(expr=   2*m.b458 + m.x498 <= 0)

m.c867 = Constraint(expr=   6*m.b459 + m.x499 <= 0)

m.c868 = Constraint(expr=   4*m.b460 + m.x500 <= 0)

m.c869 = Constraint(expr=   8*m.b461 + m.x501 <= 0)

m.c870 = Constraint(expr=   2*m.b462 + m.x502 <= 0)

m.c871 = Constraint(expr=   5*m.b463 + m.x503 <= 0)

m.c872 = Constraint(expr=   3*m.b464 + m.x504 <= 0)

m.c873 = Constraint(expr=   4*m.b465 + m.x505 <= 0)

m.c874 = Constraint(expr=   5*m.b466 + m.x506 <= 0)

m.c875 = Constraint(expr=   7*m.b467 + m.x507 <= 0)

m.c876 = Constraint(expr=   2*m.b468 + m.x508 <= 0)

m.c877 = Constraint(expr=   8*m.b469 + m.x509 <= 0)

m.c878 = Constraint(expr=   m.b470 + m.x510 <= 0)

m.c879 = Constraint(expr=   4*m.b471 + m.x511 <= 0)

m.c880 = Constraint(expr=   5*m.b432 + m.x472 >= 0)

m.c881 = Constraint(expr=   4*m.b433 + m.x473 >= 0)

m.c882 = Constraint(expr=   8*m.b434 + m.x474 >= 0)

m.c883 = Constraint(expr=   7*m.b435 + m.x475 >= 0)

m.c884 = Constraint(expr=   6*m.b436 + m.x476 >= 0)

m.c885 = Constraint(expr=   9*m.b437 + m.x477 >= 0)

m.c886 = Constraint(expr=   10*m.b438 + m.x478 >= 0)

m.c887 = Constraint(expr=   9*m.b439 + m.x479 >= 0)

m.c888 = Constraint(expr=   6*m.b440 + m.x480 >= 0)

m.c889 = Constraint(expr=   10*m.b441 + m.x481 >= 0)

m.c890 = Constraint(expr=   7*m.b442 + m.x482 >= 0)

m.c891 = Constraint(expr=   7*m.b443 + m.x483 >= 0)

m.c892 = Constraint(expr=   4*m.b444 + m.x484 >= 0)

m.c893 = Constraint(expr=   3*m.b445 + m.x485 >= 0)

m.c894 = Constraint(expr=   5*m.b446 + m.x486 >= 0)

m.c895 = Constraint(expr=   6*m.b447 + m.x487 >= 0)

m.c896 = Constraint(expr=   2*m.b448 + m.x488 >= 0)

m.c897 = Constraint(expr=   5*m.b449 + m.x489 >= 0)

m.c898 = Constraint(expr=   4*m.b450 + m.x490 >= 0)

m.c899 = Constraint(expr=   7*m.b451 + m.x491 >= 0)

m.c900 = Constraint(expr=   3*m.b452 + m.x492 >= 0)

m.c901 = Constraint(expr=   9*m.b453 + m.x493 >= 0)

m.c902 = Constraint(expr=   7*m.b454 + m.x494 >= 0)

m.c903 = Constraint(expr=   2*m.b455 + m.x495 >= 0)

m.c904 = Constraint(expr=   3*m.b456 + m.x496 >= 0)

m.c905 = Constraint(expr=   m.b457 + m.x497 >= 0)

m.c906 = Constraint(expr=   2*m.b458 + m.x498 >= 0)

m.c907 = Constraint(expr=   6*m.b459 + m.x499 >= 0)

m.c908 = Constraint(expr=   4*m.b460 + m.x500 >= 0)

m.c909 = Constraint(expr=   8*m.b461 + m.x501 >= 0)

m.c910 = Constraint(expr=   2*m.b462 + m.x502 >= 0)

m.c911 = Constraint(expr=   5*m.b463 + m.x503 >= 0)

m.c912 = Constraint(expr=   3*m.b464 + m.x504 >= 0)

m.c913 = Constraint(expr=   4*m.b465 + m.x505 >= 0)

m.c914 = Constraint(expr=   5*m.b466 + m.x506 >= 0)

m.c915 = Constraint(expr=   7*m.b467 + m.x507 >= 0)

m.c916 = Constraint(expr=   2*m.b468 + m.x508 >= 0)

m.c917 = Constraint(expr=   8*m.b469 + m.x509 >= 0)

m.c918 = Constraint(expr=   m.b470 + m.x510 >= 0)

m.c919 = Constraint(expr=   4*m.b471 + m.x511 >= 0)

m.c920 = Constraint(expr=   m.b392 - m.b393 <= 0)

m.c921 = Constraint(expr=   m.b394 - m.b395 <= 0)

m.c922 = Constraint(expr=   m.b396 - m.b397 <= 0)

m.c923 = Constraint(expr=   m.b398 - m.b399 <= 0)

m.c924 = Constraint(expr=   m.b400 - m.b401 <= 0)

m.c925 = Constraint(expr=   m.b402 - m.b403 <= 0)

m.c926 = Constraint(expr=   m.b404 - m.b405 <= 0)

m.c927 = Constraint(expr=   m.b406 - m.b407 <= 0)

m.c928 = Constraint(expr=   m.b408 - m.b409 <= 0)

m.c929 = Constraint(expr=   m.b410 - m.b411 <= 0)

m.c930 = Constraint(expr=   m.b412 - m.b413 <= 0)

m.c931 = Constraint(expr=   m.b414 - m.b415 <= 0)

m.c932 = Constraint(expr=   m.b416 - m.b417 <= 0)

m.c933 = Constraint(expr=   m.b418 - m.b419 <= 0)

m.c934 = Constraint(expr=   m.b420 - m.b421 <= 0)

m.c935 = Constraint(expr=   m.b422 - m.b423 <= 0)

m.c936 = Constraint(expr=   m.b424 - m.b425 <= 0)

m.c937 = Constraint(expr=   m.b426 - m.b427 <= 0)

m.c938 = Constraint(expr=   m.b428 - m.b429 <= 0)

m.c939 = Constraint(expr=   m.b430 - m.b431 <= 0)

m.c940 = Constraint(expr=   m.b432 + m.b433 <= 1)

m.c941 = Constraint(expr=   m.b432 + m.b433 <= 1)

m.c942 = Constraint(expr=   m.b434 + m.b435 <= 1)

m.c943 = Constraint(expr=   m.b434 + m.b435 <= 1)

m.c944 = Constraint(expr=   m.b436 + m.b437 <= 1)

m.c945 = Constraint(expr=   m.b436 + m.b437 <= 1)

m.c946 = Constraint(expr=   m.b438 + m.b439 <= 1)

m.c947 = Constraint(expr=   m.b438 + m.b439 <= 1)

m.c948 = Constraint(expr=   m.b440 + m.b441 <= 1)

m.c949 = Constraint(expr=   m.b440 + m.b441 <= 1)

m.c950 = Constraint(expr=   m.b442 + m.b443 <= 1)

m.c951 = Constraint(expr=   m.b442 + m.b443 <= 1)

m.c952 = Constraint(expr=   m.b444 + m.b445 <= 1)

m.c953 = Constraint(expr=   m.b444 + m.b445 <= 1)

m.c954 = Constraint(expr=   m.b446 + m.b447 <= 1)

m.c955 = Constraint(expr=   m.b446 + m.b447 <= 1)

m.c956 = Constraint(expr=   m.b448 + m.b449 <= 1)

m.c957 = Constraint(expr=   m.b448 + m.b449 <= 1)

m.c958 = Constraint(expr=   m.b450 + m.b451 <= 1)

m.c959 = Constraint(expr=   m.b450 + m.b451 <= 1)

m.c960 = Constraint(expr=   m.b452 + m.b453 <= 1)

m.c961 = Constraint(expr=   m.b452 + m.b453 <= 1)

m.c962 = Constraint(expr=   m.b454 + m.b455 <= 1)

m.c963 = Constraint(expr=   m.b454 + m.b455 <= 1)

m.c964 = Constraint(expr=   m.b456 + m.b457 <= 1)

m.c965 = Constraint(expr=   m.b456 + m.b457 <= 1)

m.c966 = Constraint(expr=   m.b458 + m.b459 <= 1)

m.c967 = Constraint(expr=   m.b458 + m.b459 <= 1)

m.c968 = Constraint(expr=   m.b460 + m.b461 <= 1)

m.c969 = Constraint(expr=   m.b460 + m.b461 <= 1)

m.c970 = Constraint(expr=   m.b462 + m.b463 <= 1)

m.c971 = Constraint(expr=   m.b462 + m.b463 <= 1)

m.c972 = Constraint(expr=   m.b464 + m.b465 <= 1)

m.c973 = Constraint(expr=   m.b464 + m.b465 <= 1)

m.c974 = Constraint(expr=   m.b466 + m.b467 <= 1)

m.c975 = Constraint(expr=   m.b466 + m.b467 <= 1)

m.c976 = Constraint(expr=   m.b468 + m.b469 <= 1)

m.c977 = Constraint(expr=   m.b468 + m.b469 <= 1)

m.c978 = Constraint(expr=   m.b470 + m.b471 <= 1)

m.c979 = Constraint(expr=   m.b470 + m.b471 <= 1)

m.c980 = Constraint(expr=   m.b392 - m.b432 <= 0)

m.c981 = Constraint(expr= - m.b392 + m.b393 - m.b433 <= 0)

m.c982 = Constraint(expr=   m.b394 - m.b434 <= 0)

m.c983 = Constraint(expr= - m.b394 + m.b395 - m.b435 <= 0)

m.c984 = Constraint(expr=   m.b396 - m.b436 <= 0)

m.c985 = Constraint(expr= - m.b396 + m.b397 - m.b437 <= 0)

m.c986 = Constraint(expr=   m.b398 - m.b438 <= 0)

m.c987 = Constraint(expr= - m.b398 + m.b399 - m.b439 <= 0)

m.c988 = Constraint(expr=   m.b400 - m.b440 <= 0)

m.c989 = Constraint(expr= - m.b400 + m.b401 - m.b441 <= 0)

m.c990 = Constraint(expr=   m.b402 - m.b442 <= 0)

m.c991 = Constraint(expr= - m.b402 + m.b403 - m.b443 <= 0)

m.c992 = Constraint(expr=   m.b404 - m.b444 <= 0)

m.c993 = Constraint(expr= - m.b404 + m.b405 - m.b445 <= 0)

m.c994 = Constraint(expr=   m.b406 - m.b446 <= 0)

m.c995 = Constraint(expr= - m.b406 + m.b407 - m.b447 <= 0)

m.c996 = Constraint(expr=   m.b408 - m.b448 <= 0)

m.c997 = Constraint(expr= - m.b408 + m.b409 - m.b449 <= 0)

m.c998 = Constraint(expr=   m.b410 - m.b450 <= 0)

m.c999 = Constraint(expr= - m.b410 + m.b411 - m.b451 <= 0)

m.c1000 = Constraint(expr=   m.b412 - m.b452 <= 0)

m.c1001 = Constraint(expr= - m.b412 + m.b413 - m.b453 <= 0)

m.c1002 = Constraint(expr=   m.b414 - m.b454 <= 0)

m.c1003 = Constraint(expr= - m.b414 + m.b415 - m.b455 <= 0)

m.c1004 = Constraint(expr=   m.b416 - m.b456 <= 0)

m.c1005 = Constraint(expr= - m.b416 + m.b417 - m.b457 <= 0)

m.c1006 = Constraint(expr=   m.b418 - m.b458 <= 0)

m.c1007 = Constraint(expr= - m.b418 + m.b419 - m.b459 <= 0)

m.c1008 = Constraint(expr=   m.b420 - m.b460 <= 0)

m.c1009 = Constraint(expr= - m.b420 + m.b421 - m.b461 <= 0)

m.c1010 = Constraint(expr=   m.b422 - m.b462 <= 0)

m.c1011 = Constraint(expr= - m.b422 + m.b423 - m.b463 <= 0)

m.c1012 = Constraint(expr=   m.b424 - m.b464 <= 0)

m.c1013 = Constraint(expr= - m.b424 + m.b425 - m.b465 <= 0)

m.c1014 = Constraint(expr=   m.b426 - m.b466 <= 0)

m.c1015 = Constraint(expr= - m.b426 + m.b427 - m.b467 <= 0)

m.c1016 = Constraint(expr=   m.b428 - m.b468 <= 0)

m.c1017 = Constraint(expr= - m.b428 + m.b429 - m.b469 <= 0)

m.c1018 = Constraint(expr=   m.b430 - m.b470 <= 0)

m.c1019 = Constraint(expr= - m.b430 + m.b431 - m.b471 <= 0)

m.c1020 = Constraint(expr=   m.b392 + m.b394 == 1)

m.c1021 = Constraint(expr=   m.b393 + m.b395 == 1)

m.c1022 = Constraint(expr= - m.b396 + m.b402 + m.b404 >= 0)

m.c1023 = Constraint(expr= - m.b397 + m.b403 + m.b405 >= 0)

m.c1024 = Constraint(expr= - m.b402 + m.b414 >= 0)

m.c1025 = Constraint(expr= - m.b403 + m.b415 >= 0)

m.c1026 = Constraint(expr= - m.b404 + m.b416 >= 0)

m.c1027 = Constraint(expr= - m.b405 + m.b417 >= 0)

m.c1028 = Constraint(expr= - m.b398 + m.b406 >= 0)

m.c1029 = Constraint(expr= - m.b399 + m.b407 >= 0)

m.c1030 = Constraint(expr= - m.b406 + m.b418 + m.b420 >= 0)

m.c1031 = Constraint(expr= - m.b407 + m.b419 + m.b421 >= 0)

m.c1032 = Constraint(expr= - m.b400 + m.b408 + m.b410 + m.b412 >= 0)

m.c1033 = Constraint(expr= - m.b401 + m.b409 + m.b411 + m.b413 >= 0)

m.c1034 = Constraint(expr= - m.b408 + m.b420 >= 0)

m.c1035 = Constraint(expr= - m.b409 + m.b421 >= 0)

m.c1036 = Constraint(expr= - m.b410 + m.b422 + m.b424 >= 0)

m.c1037 = Constraint(expr= - m.b411 + m.b423 + m.b425 >= 0)

m.c1038 = Constraint(expr= - m.b412 + m.b426 + m.b428 + m.b430 >= 0)

m.c1039 = Constraint(expr= - m.b413 + m.b427 + m.b429 + m.b431 >= 0)

m.c1040 = Constraint(expr=   m.b392 + m.b394 - m.b396 >= 0)

m.c1041 = Constraint(expr=   m.b393 + m.b395 - m.b397 >= 0)

m.c1042 = Constraint(expr=   m.b392 + m.b394 - m.b398 >= 0)

m.c1043 = Constraint(expr=   m.b393 + m.b395 - m.b399 >= 0)

m.c1044 = Constraint(expr=   m.b392 + m.b394 - m.b400 >= 0)

m.c1045 = Constraint(expr=   m.b393 + m.b395 - m.b401 >= 0)

m.c1046 = Constraint(expr=   m.b396 - m.b402 >= 0)

m.c1047 = Constraint(expr=   m.b397 - m.b403 >= 0)

m.c1048 = Constraint(expr=   m.b396 - m.b404 >= 0)

m.c1049 = Constraint(expr=   m.b397 - m.b405 >= 0)

m.c1050 = Constraint(expr=   m.b398 - m.b406 >= 0)

m.c1051 = Constraint(expr=   m.b399 - m.b407 >= 0)

m.c1052 = Constraint(expr=   m.b400 - m.b408 >= 0)

m.c1053 = Constraint(expr=   m.b401 - m.b409 >= 0)

m.c1054 = Constraint(expr=   m.b400 - m.b410 >= 0)

m.c1055 = Constraint(expr=   m.b401 - m.b411 >= 0)

m.c1056 = Constraint(expr=   m.b400 - m.b412 >= 0)

m.c1057 = Constraint(expr=   m.b401 - m.b413 >= 0)

m.c1058 = Constraint(expr=   m.b402 - m.b414 >= 0)

m.c1059 = Constraint(expr=   m.b403 - m.b415 >= 0)

m.c1060 = Constraint(expr=   m.b404 - m.b416 >= 0)

m.c1061 = Constraint(expr=   m.b405 - m.b417 >= 0)

m.c1062 = Constraint(expr=   m.b406 - m.b418 >= 0)

m.c1063 = Constraint(expr=   m.b407 - m.b419 >= 0)

m.c1064 = Constraint(expr=   m.b406 - m.b420 >= 0)

m.c1065 = Constraint(expr=   m.b407 - m.b421 >= 0)

m.c1066 = Constraint(expr=   m.b410 - m.b422 >= 0)

m.c1067 = Constraint(expr=   m.b411 - m.b423 >= 0)

m.c1068 = Constraint(expr=   m.b410 - m.b424 >= 0)

m.c1069 = Constraint(expr=   m.b411 - m.b425 >= 0)

m.c1070 = Constraint(expr=   m.b412 - m.b426 >= 0)

m.c1071 = Constraint(expr=   m.b413 - m.b427 >= 0)

m.c1072 = Constraint(expr=   m.b412 - m.b428 >= 0)

m.c1073 = Constraint(expr=   m.b413 - m.b429 >= 0)

m.c1074 = Constraint(expr=   m.b412 - m.b430 >= 0)

m.c1075 = Constraint(expr=   m.b413 - m.b431 >= 0)
