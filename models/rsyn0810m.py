...
m.obj = Objective(expr= - 4*m.x2 - 8*m.x7 - 5*m.x11 - 8*m.x23 + 23*m.x27 + 19*m.x29 - 10*m.x30 + 2*m.x33 + 3*m.x34
                        + 25*m.x35 + 24*m.x36 - 6*m.b89 - 40*m.b90 - 46*m.b91 - 7*m.b93 - 30*m.b94 - 37*m.b95 - 7*m.b97
                        ...
                        - 23*m.b119 + 5*m.x158 - 2*m.x163 + 200*m.x171 + 250*m.x172 + 200*m.x173 + 200*m.x174
                        + 500*m.x175 + 350*m.x176 - 5*m.b177 - 8*m.b178 - 6*m.b179 - 10*m.b180 - 6*m.b181 - 7*m.b182
                        - 4*m.b183 - 5*m.b184 - 2*m.b185 - 4*m.b186, sense=maximize)
...
m.c258 = Constraint(expr=   m.x21 - m.x35 == 0)

m.c259 = Constraint(expr=   m.x22 - m.x36 == 0)
...
m.c266 = Constraint(expr=-log(1 + m.x153) + m.x155 + m.b177 <= 1)

m.c267 = Constraint(expr=   m.x153 - 10*m.b177 <= 0)

m.c268 = Constraint(expr=   m.x155 - 2.39789527279837*m.b177 <= 0)

m.c269 = Constraint(expr=-1.2*log(1 + m.x154) + m.x156 + m.b178 <= 1)

m.c270 = Constraint(expr=   m.x154 - 10*m.b178 <= 0)

m.c271 = Constraint(expr=   m.x156 - 2.87747432735804*m.b178 <= 0)

m.c272 = Constraint(expr= - 0.75*m.x160 + m.x164 + m.b179 <= 1)

m.c273 = Constraint(expr= - 0.75*m.x160 + m.x164 - m.b179 >= -1)

m.c274 = Constraint(expr=   m.x160 - 2.87747432735804*m.b179 <= 0)

m.c275 = Constraint(expr=   m.x164 - 2.15810574551853*m.b179 <= 0)

m.c276 = Constraint(expr=-1.5*log(1 + m.x161) + m.x165 + m.b180 <= 1)

m.c277 = Constraint(expr=   m.x161 - 2.87747432735804*m.b180 <= 0)

m.c278 = Constraint(expr=   m.x165 - 2.03277599268042*m.b180 <= 0)

m.c279 = Constraint(expr= - m.x162 + m.x166 + m.b181 <= 1)

m.c280 = Constraint(expr= - m.x162 + m.x166 - m.b181 >= -1)

m.c281 = Constraint(expr= - 0.5*m.x163 + m.x166 + m.b181 <= 1)

m.c282 = Constraint(expr= - 0.5*m.x163 + m.x166 - m.b181 >= -1)

m.c283 = Constraint(expr=   m.x162 - 2.87747432735804*m.b181 <= 0)

m.c284 = Constraint(expr=   m.x163 - 7*m.b181 <= 0)

m.c285 = Constraint(expr=   m.x166 - 3.5*m.b181 <= 0)

m.c286 = Constraint(expr=-1.25*log(1 + m.x167) + m.x172 + m.b182 <= 1)

m.c287 = Constraint(expr=   m.x167 - 2.15810574551853*m.b182 <= 0)

m.c288 = Constraint(expr=   m.x172 - 1.43746550029693*m.b182 <= 0)

m.c289 = Constraint(expr=-0.9*log(1 + m.x168) + m.x173 + m.b183 <= 1)

m.c290 = Constraint(expr=   m.x168 - 2.15810574551853*m.b183 <= 0)

m.c291 = Constraint(expr=   m.x173 - 1.03497516021379*m.b183 <= 0)

m.c292 = Constraint(expr=-log(1 + m.x165) + m.x174 + m.b184 <= 1)

m.c293 = Constraint(expr=   m.x165 - 2.03277599268042*m.b184 <= 0)

m.c294 = Constraint(expr=   m.x174 - 1.10947836929589*m.b184 <= 0)

m.c295 = Constraint(expr= - 0.9*m.x169 + m.x175 + m.b185 <= 1)

m.c296 = Constraint(expr= - 0.9*m.x169 + m.x175 - m.b185 >= -1)

m.c297 = Constraint(expr=   m.x169 - 3.5*m.b185 <= 0)

m.c298 = Constraint(expr=   m.x175 - 3.15*m.b185 <= 0)

m.c299 = Constraint(expr= - 0.6*m.x170 + m.x176 + m.b186 <= 1)

m.c300 = Constraint(expr= - 0.6*m.x170 + m.x176 - m.b186 >= -1)

m.c301 = Constraint(expr=   m.x170 - 3.5*m.b186 <= 0)

m.c302 = Constraint(expr=   m.x176 - 2.1*m.b186 <= 0)

m.c303 = Constraint(expr=   m.b177 + m.b178 == 1)

m.c304 = Constraint(expr= - m.b179 + m.b182 + m.b183 >= 0)

m.c305 = Constraint(expr= - m.b180 + m.b184 >= 0)

m.c306 = Constraint(expr=   m.b177 + m.b178 - m.b179 >= 0)

m.c307 = Constraint(expr=   m.b177 + m.b178 - m.b180 >= 0)

m.c308 = Constraint(expr=   m.b177 + m.b178 - m.b181 >= 0)

m.c309 = Constraint(expr=   m.b179 - m.b182 >= 0)

m.c310 = Constraint(expr=   m.b179 - m.b183 >= 0)

m.c311 = Constraint(expr=   m.b180 - m.b184 >= 0)

m.c312 = Constraint(expr=   m.b181 - m.b185 >= 0)

m.c313 = Constraint(expr=   m.b181 - m.b186 >= 0)
