...
m.x76 = Var(within=Reals,bounds=(1.7889,8.9443),initialize=1.7889)
m.x77 = Var(within=Reals,bounds=(1.7889,8.9443),initialize=1.7889)
m.x78 = Var(within=Reals,bounds=(1.7889,8.9443),initialize=1.7889)
m.x79 = Var(within=Reals,bounds=(1.7889,8.9443),initialize=1.7889)
m.x80 = Var(within=Reals,bounds=(1.7889,8.9443),initialize=1.7889)
m.x81 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x82 = Var(within=Reals,bounds=(1.7889,8.9443),initialize=1.7889)
m.x83 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x84 = Var(within=Reals,bounds=(2.7692,11.31),initialize=2.7692)
m.x85 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x86 = Var(within=Reals,bounds=(3.183,13),initialize=3.183)
m.x87 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x88 = Var(within=Reals,bounds=(2.7692,11.31),initialize=2.7692)
m.x89 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x90 = Var(within=Reals,bounds=(3.183,13),initialize=3.183)
m.x91 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x92 = Var(within=Reals,bounds=(1.3416,6.7082),initialize=1.3416)
m.x93 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x94 = Var(within=Reals,bounds=(1.3416,6.7082),initialize=1.3416)
m.x95 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x96 = Var(within=Reals,bounds=(1.3416,6.7082),initialize=1.3416)
...
m.x102 = Var(within=Reals,bounds=(1.3416,6.7082),initialize=1.3416)
...
m.c61 = Constraint(expr= - 0.559003*m.x76 - 0.111806*m.x78 <= -2)

m.c62 = Constraint(expr= - 0.111803*m.x76 - 0.559019*m.x78 <= -2)

m.c63 = Constraint(expr= - 0.559003*m.x77 - 0.111806*m.x79 <= -2)

m.c64 = Constraint(expr= - 0.111803*m.x77 - 0.559019*m.x79 <= -2)

m.c65 = Constraint(expr= - 0.559003*m.x80 - 0.111806*m.x82 <= -2)

m.c66 = Constraint(expr= - 0.111803*m.x80 - 0.559019*m.x82 <= -2)

m.c67 = Constraint(expr= - 0.361115*m.x84 - 0.076922*m.x86 <= -2)

m.c68 = Constraint(expr= - 0.088417*m.x84 - 0.314167*m.x86 <= -2)

m.c69 = Constraint(expr= - 0.361115*m.x88 - 0.076922*m.x90 <= -2)

m.c70 = Constraint(expr= - 0.088417*m.x88 - 0.314167*m.x90 <= -2)

m.c71 = Constraint(expr= - 0.745379*m.x92 - 0.149067*m.x94 <= -2)

m.c72 = Constraint(expr= - 0.149071*m.x92 - 0.745356*m.x94 <= -2)

m.c73 = Constraint(expr= - 0.745379*m.x96 - 0.149067*m.x98 <= -2)

m.c74 = Constraint(expr= - 0.149071*m.x96 - 0.745356*m.x98 <= -2)

m.c75 = Constraint(expr= - 0.745379*m.x100 - 0.149067*m.x102 <= -2)

m.c76 = Constraint(expr= - 0.149071*m.x100 - 0.745356*m.x102 <= -2)
