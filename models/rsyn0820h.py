...
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        605      283       33      289        0        0        0        0
#  
#  Variable counts
#                   x        b        i      s1s      s2s       sc       si
#      Total     cont   binary  integer     sos1     sos2    scont     sint
#        418      366       52        0        0        0        0        0
#  FX      0        0        0        0        0        0        0        0
#  
#  Nonzero counts
#      Total    const       NL      DLL
...
m.obj = Objective(expr= - 10*m.x2 - 15*m.x7 - 18*m.x11 - 19*m.x23 + 35*m.x27 + 28*m.x29 - 16*m.x30 + 2*m.x33 + 3*m.x34
                        ...
                        - 15*m.b266 - 23*m.b267 + 5*m.x274 + 200*m.x304 + 250*m.x305 + 200*m.x306 + 700*m.x307
                        + 400*m.x308 + 500*m.x309 + 400*m.x310 + 600*m.x311 + 700*m.x312 - 5*m.b399 - 8*m.b400
                        - 6*m.b401 - 10*m.b402 - 6*m.b403 - 7*m.b404 - 4*m.b405 - 5*m.b406 - 2*m.b407 - 4*m.b408
                        - 3*m.b409 - 7*m.b410 - 3*m.b411 - 2*m.b412 - 4*m.b413 - 2*m.b414 - 3*m.b415 - 5*m.b416
                        - 2*m.b417 - 8*m.b418, sense=maximize)
...
m.c383 = Constraint(expr=(m.x317/(1e-6 + m.b399) - log(1 + m.x313/(1e-6 + m.b399)))*(1e-6 + m.b399) <= 0)

m.c384 = Constraint(expr=   m.x314 == 0)

m.c385 = Constraint(expr=   m.x318 == 0)

m.c386 = Constraint(expr=   m.x269 - m.x313 - m.x314 == 0)

m.c387 = Constraint(expr=   m.x271 - m.x317 - m.x318 == 0)

m.c388 = Constraint(expr=   m.x313 - 10*m.b399 <= 0)

m.c389 = Constraint(expr=   m.x314 + 10*m.b399 <= 10)

m.c390 = Constraint(expr=   m.x317 - 2.39789527279837*m.b399 <= 0)

m.c391 = Constraint(expr=   m.x318 + 2.39789527279837*m.b399 <= 2.39789527279837)

m.c392 = Constraint(expr=(m.x319/(1e-6 + m.b400) - 1.2*log(1 + m.x315/(1e-6 + m.b400)))*(1e-6 + m.b400) <= 0)

m.c393 = Constraint(expr=   m.x316 == 0)

m.c394 = Constraint(expr=   m.x320 == 0)

m.c395 = Constraint(expr=   m.x270 - m.x315 - m.x316 == 0)

m.c396 = Constraint(expr=   m.x272 - m.x319 - m.x320 == 0)

m.c397 = Constraint(expr=   m.x315 - 10*m.b400 <= 0)

m.c398 = Constraint(expr=   m.x316 + 10*m.b400 <= 10)

m.c399 = Constraint(expr=   m.x319 - 2.87747432735804*m.b400 <= 0)

m.c400 = Constraint(expr=   m.x320 + 2.87747432735804*m.b400 <= 2.87747432735804)

m.c401 = Constraint(expr= - 0.75*m.x321 + m.x329 == 0)

m.c402 = Constraint(expr=   m.x322 == 0)

m.c403 = Constraint(expr=   m.x330 == 0)

m.c404 = Constraint(expr=   m.x276 - m.x321 - m.x322 == 0)

m.c405 = Constraint(expr=   m.x280 - m.x329 - m.x330 == 0)

m.c406 = Constraint(expr=   m.x321 - 2.87747432735804*m.b401 <= 0)

m.c407 = Constraint(expr=   m.x322 + 2.87747432735804*m.b401 <= 2.87747432735804)

m.c408 = Constraint(expr=   m.x329 - 2.15810574551853*m.b401 <= 0)

m.c409 = Constraint(expr=   m.x330 + 2.15810574551853*m.b401 <= 2.15810574551853)

m.c410 = Constraint(expr=(m.x331/(1e-6 + m.b402) - 1.5*log(1 + m.x323/(1e-6 + m.b402)))*(1e-6 + m.b402) <= 0)

m.c411 = Constraint(expr=   m.x324 == 0)

m.c412 = Constraint(expr=   m.x333 == 0)

m.c413 = Constraint(expr=   m.x277 - m.x323 - m.x324 == 0)

m.c414 = Constraint(expr=   m.x281 - m.x331 - m.x333 == 0)

m.c415 = Constraint(expr=   m.x323 - 2.87747432735804*m.b402 <= 0)

m.c416 = Constraint(expr=   m.x324 + 2.87747432735804*m.b402 <= 2.87747432735804)

m.c417 = Constraint(expr=   m.x331 - 2.03277599268042*m.b402 <= 0)

m.c418 = Constraint(expr=   m.x333 + 2.03277599268042*m.b402 <= 2.03277599268042)

m.c419 = Constraint(expr= - m.x325 + m.x335 == 0)

m.c420 = Constraint(expr= - 0.5*m.x327 + m.x335 == 0)

m.c421 = Constraint(expr=   m.x326 == 0)

m.c422 = Constraint(expr=   m.x328 == 0)

m.c423 = Constraint(expr=   m.x336 == 0)

m.c424 = Constraint(expr=   m.x278 - m.x325 - m.x326 == 0)

m.c425 = Constraint(expr=   m.x279 - m.x327 - m.x328 == 0)

m.c426 = Constraint(expr=   m.x282 - m.x335 - m.x336 == 0)

m.c427 = Constraint(expr=   m.x325 - 2.87747432735804*m.b403 <= 0)

m.c428 = Constraint(expr=   m.x326 + 2.87747432735804*m.b403 <= 2.87747432735804)

m.c429 = Constraint(expr=   m.x327 - 7*m.b403 <= 0)

m.c430 = Constraint(expr=   m.x328 + 7*m.b403 <= 7)

m.c431 = Constraint(expr=   m.x335 - 3.5*m.b403 <= 0)

m.c432 = Constraint(expr=   m.x336 + 3.5*m.b403 <= 3.5)

m.c433 = Constraint(expr=(m.x347/(1e-6 + m.b404) - 1.25*log(1 + m.x337/(1e-6 + m.b404)))*(1e-6 + m.b404) <= 0)

m.c434 = Constraint(expr=   m.x338 == 0)

m.c435 = Constraint(expr=   m.x349 == 0)

m.c436 = Constraint(expr=   m.x283 - m.x337 - m.x338 == 0)

m.c437 = Constraint(expr=   m.x288 - m.x347 - m.x349 == 0)

m.c438 = Constraint(expr=   m.x337 - 2.15810574551853*m.b404 <= 0)

m.c439 = Constraint(expr=   m.x338 + 2.15810574551853*m.b404 <= 2.15810574551853)

m.c440 = Constraint(expr=   m.x347 - 1.43746550029693*m.b404 <= 0)

m.c441 = Constraint(expr=   m.x349 + 1.43746550029693*m.b404 <= 1.43746550029693)

m.c442 = Constraint(expr=(m.x351/(1e-6 + m.b405) - 0.9*log(1 + m.x339/(1e-6 + m.b405)))*(1e-6 + m.b405) <= 0)

m.c443 = Constraint(expr=   m.x340 == 0)

m.c444 = Constraint(expr=   m.x353 == 0)

m.c445 = Constraint(expr=   m.x284 - m.x339 - m.x340 == 0)

m.c446 = Constraint(expr=   m.x289 - m.x351 - m.x353 == 0)

m.c447 = Constraint(expr=   m.x339 - 2.15810574551853*m.b405 <= 0)

m.c448 = Constraint(expr=   m.x340 + 2.15810574551853*m.b405 <= 2.15810574551853)

m.c449 = Constraint(expr=   m.x351 - 1.03497516021379*m.b405 <= 0)

m.c450 = Constraint(expr=   m.x353 + 1.03497516021379*m.b405 <= 1.03497516021379)

m.c451 = Constraint(expr=(m.x355/(1e-6 + m.b406) - log(1 + m.x332/(1e-6 + m.b406)))*(1e-6 + m.b406) <= 0)

m.c452 = Constraint(expr=   m.x334 == 0)

m.c453 = Constraint(expr=   m.x356 == 0)

m.c454 = Constraint(expr=   m.x281 - m.x332 - m.x334 == 0)

m.c455 = Constraint(expr=   m.x290 - m.x355 - m.x356 == 0)

m.c456 = Constraint(expr=   m.x332 - 2.03277599268042*m.b406 <= 0)

m.c457 = Constraint(expr=   m.x334 + 2.03277599268042*m.b406 <= 2.03277599268042)

m.c458 = Constraint(expr=   m.x355 - 1.10947836929589*m.b406 <= 0)

m.c459 = Constraint(expr=   m.x356 + 1.10947836929589*m.b406 <= 1.10947836929589)

m.c460 = Constraint(expr= - 0.9*m.x341 + m.x357 == 0)

m.c461 = Constraint(expr=   m.x342 == 0)

m.c462 = Constraint(expr=   m.x358 == 0)

m.c463 = Constraint(expr=   m.x285 - m.x341 - m.x342 == 0)

m.c464 = Constraint(expr=   m.x291 - m.x357 - m.x358 == 0)

m.c465 = Constraint(expr=   m.x341 - 3.5*m.b407 <= 0)

m.c466 = Constraint(expr=   m.x342 + 3.5*m.b407 <= 3.5)

m.c467 = Constraint(expr=   m.x357 - 3.15*m.b407 <= 0)

m.c468 = Constraint(expr=   m.x358 + 3.15*m.b407 <= 3.15)

m.c469 = Constraint(expr= - 0.6*m.x343 + m.x359 == 0)

m.c470 = Constraint(expr=   m.x344 == 0)

m.c471 = Constraint(expr=   m.x360 == 0)

m.c472 = Constraint(expr=   m.x286 - m.x343 - m.x344 == 0)

m.c473 = Constraint(expr=   m.x292 - m.x359 - m.x360 == 0)

m.c474 = Constraint(expr=   m.x343 - 3.5*m.b408 <= 0)

m.c475 = Constraint(expr=   m.x344 + 3.5*m.b408 <= 3.5)

m.c476 = Constraint(expr=   m.x359 - 2.1*m.b408 <= 0)

m.c477 = Constraint(expr=   m.x360 + 2.1*m.b408 <= 2.1)

m.c478 = Constraint(expr=(m.x361/(1e-6 + m.b409) - 1.1*log(1 + m.x345/(1e-6 + m.b409)))*(1e-6 + m.b409) <= 0)

m.c479 = Constraint(expr=   m.x346 == 0)

m.c480 = Constraint(expr=   m.x362 == 0)

m.c481 = Constraint(expr=   m.x287 - m.x345 - m.x346 == 0)

m.c482 = Constraint(expr=   m.x293 - m.x361 - m.x362 == 0)

m.c483 = Constraint(expr=   m.x345 - 3.5*m.b409 <= 0)

m.c484 = Constraint(expr=   m.x346 + 3.5*m.b409 <= 3.5)

m.c485 = Constraint(expr=   m.x361 - 1.6544851364539*m.b409 <= 0)

m.c486 = Constraint(expr=   m.x362 + 1.6544851364539*m.b409 <= 1.6544851364539)

m.c487 = Constraint(expr= - 0.9*m.x348 + m.x381 == 0)

m.c488 = Constraint(expr= - m.x367 + m.x381 == 0)

m.c489 = Constraint(expr=   m.x350 == 0)

m.c490 = Constraint(expr=   m.x368 == 0)

m.c491 = Constraint(expr=   m.x382 == 0)

m.c492 = Constraint(expr=   m.x288 - m.x348 - m.x350 == 0)

m.c493 = Constraint(expr=   m.x296 - m.x367 - m.x368 == 0)

m.c494 = Constraint(expr=   m.x304 - m.x381 - m.x382 == 0)

m.c495 = Constraint(expr=   m.x348 - 1.43746550029693*m.b410 <= 0)

m.c496 = Constraint(expr=   m.x350 + 1.43746550029693*m.b410 <= 1.43746550029693)

m.c497 = Constraint(expr=   m.x367 - 5*m.b410 <= 0)

m.c498 = Constraint(expr=   m.x368 + 5*m.b410 <= 5)

m.c499 = Constraint(expr=   m.x381 - 5*m.b410 <= 0)

m.c500 = Constraint(expr=   m.x382 + 5*m.b410 <= 5)

m.c501 = Constraint(expr=(m.x383/(1e-6 + m.b411) - log(1 + m.x352/(1e-6 + m.b411)))*(1e-6 + m.b411) <= 0)

m.c502 = Constraint(expr=   m.x354 == 0)

m.c503 = Constraint(expr=   m.x384 == 0)

m.c504 = Constraint(expr=   m.x289 - m.x352 - m.x354 == 0)

m.c505 = Constraint(expr=   m.x305 - m.x383 - m.x384 == 0)

m.c506 = Constraint(expr=   m.x352 - 1.03497516021379*m.b411 <= 0)

m.c507 = Constraint(expr=   m.x354 + 1.03497516021379*m.b411 <= 1.03497516021379)

m.c508 = Constraint(expr=   m.x383 - 0.710483612536911*m.b411 <= 0)

m.c509 = Constraint(expr=   m.x384 + 0.710483612536911*m.b411 <= 0.710483612536911)

m.c510 = Constraint(expr=(m.x385/(1e-6 + m.b412) - 0.7*log(1 + m.x363/(1e-6 + m.b412)))*(1e-6 + m.b412) <= 0)

m.c511 = Constraint(expr=   m.x364 == 0)

m.c512 = Constraint(expr=   m.x386 == 0)

m.c513 = Constraint(expr=   m.x294 - m.x363 - m.x364 == 0)

m.c514 = Constraint(expr=   m.x306 - m.x385 - m.x386 == 0)

m.c515 = Constraint(expr=   m.x363 - 1.10947836929589*m.b412 <= 0)

m.c516 = Constraint(expr=   m.x364 + 1.10947836929589*m.b412 <= 1.10947836929589)

m.c517 = Constraint(expr=   m.x385 - 0.522508489006913*m.b412 <= 0)

m.c518 = Constraint(expr=   m.x386 + 0.522508489006913*m.b412 <= 0.522508489006913)

m.c519 = Constraint(expr=(m.x387/(1e-6 + m.b413) - 0.65*log(1 + m.x365/(1e-6 + m.b413)))*(1e-6 + m.b413) <= 0)

m.c520 = Constraint(expr=(m.x387/(1e-6 + m.b413) - 0.65*log(1 + m.x369/(1e-6 + m.b413)))*(1e-6 + m.b413) <= 0)

m.c521 = Constraint(expr=   m.x366 == 0)

m.c522 = Constraint(expr=   m.x370 == 0)

m.c523 = Constraint(expr=   m.x388 == 0)

m.c524 = Constraint(expr=   m.x295 - m.x365 - m.x366 == 0)

m.c525 = Constraint(expr=   m.x298 - m.x369 - m.x370 == 0)

m.c526 = Constraint(expr=   m.x307 - m.x387 - m.x388 == 0)

m.c527 = Constraint(expr=   m.x365 - 1.10947836929589*m.b413 <= 0)

m.c528 = Constraint(expr=   m.x366 + 1.10947836929589*m.b413 <= 1.10947836929589)

m.c529 = Constraint(expr=   m.x369 - 8.15*m.b413 <= 0)

m.c530 = Constraint(expr=   m.x370 + 8.15*m.b413 <= 8.15)

m.c531 = Constraint(expr=   m.x387 - 1.43894002153683*m.b413 <= 0)

m.c532 = Constraint(expr=   m.x388 + 1.43894002153683*m.b413 <= 1.43894002153683)

m.c533 = Constraint(expr= - m.x371 + m.x389 == 0)

m.c534 = Constraint(expr=   m.x372 == 0)

m.c535 = Constraint(expr=   m.x390 == 0)

m.c536 = Constraint(expr=   m.x299 - m.x371 - m.x372 == 0)

m.c537 = Constraint(expr=   m.x308 - m.x389 - m.x390 == 0)

m.c538 = Constraint(expr=   m.x371 - 2.1*m.b414 <= 0)

m.c539 = Constraint(expr=   m.x372 + 2.1*m.b414 <= 2.1)

m.c540 = Constraint(expr=   m.x389 - 2.1*m.b414 <= 0)

m.c541 = Constraint(expr=   m.x390 + 2.1*m.b414 <= 2.1)

m.c542 = Constraint(expr= - m.x373 + m.x391 == 0)

m.c543 = Constraint(expr=   m.x374 == 0)

m.c544 = Constraint(expr=   m.x392 == 0)

m.c545 = Constraint(expr=   m.x300 - m.x373 - m.x374 == 0)

m.c546 = Constraint(expr=   m.x309 - m.x391 - m.x392 == 0)

m.c547 = Constraint(expr=   m.x373 - 2.1*m.b415 <= 0)

m.c548 = Constraint(expr=   m.x374 + 2.1*m.b415 <= 2.1)

m.c549 = Constraint(expr=   m.x391 - 2.1*m.b415 <= 0)

m.c550 = Constraint(expr=   m.x392 + 2.1*m.b415 <= 2.1)

m.c551 = Constraint(expr=(m.x393/(1e-6 + m.b416) - 0.75*log(1 + m.x375/(1e-6 + m.b416)))*(1e-6 + m.b416) <= 0)

m.c552 = Constraint(expr=   m.x376 == 0)

m.c553 = Constraint(expr=   m.x394 == 0)

m.c554 = Constraint(expr=   m.x301 - m.x375 - m.x376 == 0)

m.c555 = Constraint(expr=   m.x310 - m.x393 - m.x394 == 0)

m.c556 = Constraint(expr=   m.x375 - 1.6544851364539*m.b416 <= 0)

m.c557 = Constraint(expr=   m.x376 + 1.6544851364539*m.b416 <= 1.6544851364539)

m.c558 = Constraint(expr=   m.x393 - 0.732188035236726*m.b416 <= 0)

m.c559 = Constraint(expr=   m.x394 + 0.732188035236726*m.b416 <= 0.732188035236726)

m.c560 = Constraint(expr=(m.x395/(1e-6 + m.b417) - 0.8*log(1 + m.x377/(1e-6 + m.b417)))*(1e-6 + m.b417) <= 0)

m.c561 = Constraint(expr=   m.x378 == 0)

m.c562 = Constraint(expr=   m.x396 == 0)

m.c563 = Constraint(expr=   m.x302 - m.x377 - m.x378 == 0)

m.c564 = Constraint(expr=   m.x311 - m.x395 - m.x396 == 0)

m.c565 = Constraint(expr=   m.x377 - 1.6544851364539*m.b417 <= 0)

m.c566 = Constraint(expr=   m.x378 + 1.6544851364539*m.b417 <= 1.6544851364539)

m.c567 = Constraint(expr=   m.x395 - 0.781000570919175*m.b417 <= 0)

m.c568 = Constraint(expr=   m.x396 + 0.781000570919175*m.b417 <= 0.781000570919175)

m.c569 = Constraint(expr=(m.x397/(1e-6 + m.b418) - 0.85*log(1 + m.x379/(1e-6 + m.b418)))*(1e-6 + m.b418) <= 0)

m.c570 = Constraint(expr=   m.x380 == 0)

m.c571 = Constraint(expr=   m.x398 == 0)

m.c572 = Constraint(expr=   m.x303 - m.x379 - m.x380 == 0)

m.c573 = Constraint(expr=   m.x312 - m.x397 - m.x398 == 0)

m.c574 = Constraint(expr=   m.x379 - 1.6544851364539*m.b418 <= 0)

m.c575 = Constraint(expr=   m.x380 + 1.6544851364539*m.b418 <= 1.6544851364539)

m.c576 = Constraint(expr=   m.x397 - 0.829813106601623*m.b418 <= 0)

m.c577 = Constraint(expr=   m.x398 + 0.829813106601623*m.b418 <= 0.829813106601623)

m.c578 = Constraint(expr=   m.b399 + m.b400 == 1)

m.c579 = Constraint(expr= - m.b401 + m.b404 + m.b405 >= 0)

m.c580 = Constraint(expr= - m.b404 + m.b410 >= 0)

m.c581 = Constraint(expr= - m.b405 + m.b411 >= 0)

m.c582 = Constraint(expr= - m.b402 + m.b406 >= 0)

m.c583 = Constraint(expr= - m.b406 + m.b412 + m.b413 >= 0)

m.c584 = Constraint(expr= - m.b403 + m.b407 + m.b408 + m.b409 >= 0)

m.c585 = Constraint(expr= - m.b407 + m.b413 >= 0)

m.c586 = Constraint(expr= - m.b408 + m.b414 + m.b415 >= 0)

m.c587 = Constraint(expr= - m.b409 + m.b416 + m.b417 + m.b418 >= 0)

m.c588 = Constraint(expr=   m.b399 + m.b400 - m.b401 >= 0)

m.c589 = Constraint(expr=   m.b399 + m.b400 - m.b402 >= 0)

m.c590 = Constraint(expr=   m.b399 + m.b400 - m.b403 >= 0)

m.c591 = Constraint(expr=   m.b401 - m.b404 >= 0)

m.c592 = Constraint(expr=   m.b401 - m.b405 >= 0)

m.c593 = Constraint(expr=   m.b402 - m.b406 >= 0)

m.c594 = Constraint(expr=   m.b403 - m.b407 >= 0)

m.c595 = Constraint(expr=   m.b403 - m.b408 >= 0)

m.c596 = Constraint(expr=   m.b403 - m.b409 >= 0)

m.c597 = Constraint(expr=   m.b404 - m.b410 >= 0)

m.c598 = Constraint(expr=   m.b405 - m.b411 >= 0)

m.c599 = Constraint(expr=   m.b406 - m.b412 >= 0)

m.c600 = Constraint(expr=   m.b406 - m.b413 >= 0)

m.c601 = Constraint(expr=   m.b408 - m.b414 >= 0)

m.c602 = Constraint(expr=   m.b408 - m.b415 >= 0)

m.c603 = Constraint(expr=   m.b409 - m.b416 >= 0)

m.c604 = Constraint(expr=   m.b409 - m.b417 >= 0)

m.c605 = Constraint(expr=   m.b409 - m.b418 >= 0)
