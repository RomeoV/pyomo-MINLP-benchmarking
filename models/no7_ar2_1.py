...
m.x67 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x68 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x69 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
m.x70 = Var(within=Reals,bounds=(2.8284,5.6569),initialize=2.8284)
...
m.x76 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
m.x77 = Var(within=Reals,bounds=(4.2426,8.4853),initialize=4.2426)
...
m.x87 = Var(within=Reals,bounds=(2.1213,4.2426),initialize=2.1213)
...
m.c47 = Constraint(expr= - 0.353557*m.x66 - 0.176775*m.x69 <= -2)

m.c48 = Constraint(expr= - 0.176775*m.x66 - 0.353556*m.x69 <= -2)

m.c49 = Constraint(expr= - 0.353557*m.x67 - 0.176775*m.x70 <= -2)

m.c50 = Constraint(expr= - 0.176775*m.x67 - 0.353556*m.x70 <= -2)

m.c51 = Constraint(expr= - 0.353557*m.x72 - 0.176775*m.x74 <= -2)

m.c52 = Constraint(expr= - 0.176775*m.x72 - 0.353556*m.x74 <= -2)

m.c53 = Constraint(expr= - 0.235705*m.x76 - 0.11785*m.x77 <= -2)

m.c54 = Constraint(expr= - 0.117851*m.x76 - 0.235703*m.x77 <= -2)

m.c55 = Constraint(expr= - 0.471409*m.x78 - 0.2357*m.x80 <= -2)

m.c56 = Constraint(expr= - 0.235705*m.x78 - 0.4714*m.x80 <= -2)

m.c57 = Constraint(expr= - 0.471409*m.x82 - 0.2357*m.x84 <= -2)

m.c58 = Constraint(expr= - 0.235705*m.x82 - 0.4714*m.x84 <= -2)

m.c59 = Constraint(expr= - 0.471409*m.x86 - 0.2357*m.x87 <= -2)

m.c60 = Constraint(expr= - 0.235705*m.x86 - 0.4714*m.x87 <= -2)
