...
m.obj = Objective(expr= - 4*m.x2 - 8*m.x7 - 5*m.x11 - 8*m.x23 + 23*m.x27 + 19*m.x29 - 10*m.x30 + 2*m.x33 + 3*m.x34
                        ...
                        - 15*m.b266 - 23*m.b267 + 5*m.x274 + 500*m.x292 + 350*m.x293 + 200*m.x304 + 250*m.x305
                        + 200*m.x306 + 200*m.x307 - 5*m.b374 - 8*m.b375 - 6*m.b376 - 10*m.b377 - 6*m.b378 - 7*m.b379
                        - 4*m.b380 - 5*m.b381 - 2*m.b382 - 4*m.b383 - 3*m.b384 - 7*m.b385 - 3*m.b386 - 2*m.b387
                        - 4*m.b388, sense=maximize)
...
m.c383 = Constraint(expr=(m.x312/(1e-6 + m.b374) - log(1 + m.x308/(1e-6 + m.b374)))*(1e-6 + m.b374) <= 0)

m.c384 = Constraint(expr=   m.x309 == 0)

m.c385 = Constraint(expr=   m.x313 == 0)

m.c386 = Constraint(expr=   m.x269 - m.x308 - m.x309 == 0)

m.c387 = Constraint(expr=   m.x271 - m.x312 - m.x313 == 0)

m.c388 = Constraint(expr=   m.x308 - 10*m.b374 <= 0)

m.c389 = Constraint(expr=   m.x309 + 10*m.b374 <= 10)

m.c390 = Constraint(expr=   m.x312 - 2.39789527279837*m.b374 <= 0)

m.c391 = Constraint(expr=   m.x313 + 2.39789527279837*m.b374 <= 2.39789527279837)

m.c392 = Constraint(expr=(m.x314/(1e-6 + m.b375) - 1.2*log(1 + m.x310/(1e-6 + m.b375)))*(1e-6 + m.b375) <= 0)

m.c393 = Constraint(expr=   m.x311 == 0)

m.c394 = Constraint(expr=   m.x315 == 0)

m.c395 = Constraint(expr=   m.x270 - m.x310 - m.x311 == 0)

m.c396 = Constraint(expr=   m.x272 - m.x314 - m.x315 == 0)

m.c397 = Constraint(expr=   m.x310 - 10*m.b375 <= 0)

m.c398 = Constraint(expr=   m.x311 + 10*m.b375 <= 10)

m.c399 = Constraint(expr=   m.x314 - 2.87747432735804*m.b375 <= 0)

m.c400 = Constraint(expr=   m.x315 + 2.87747432735804*m.b375 <= 2.87747432735804)

m.c401 = Constraint(expr= - 0.75*m.x316 + m.x324 == 0)

m.c402 = Constraint(expr=   m.x317 == 0)

m.c403 = Constraint(expr=   m.x325 == 0)

m.c404 = Constraint(expr=   m.x276 - m.x316 - m.x317 == 0)

m.c405 = Constraint(expr=   m.x280 - m.x324 - m.x325 == 0)

m.c406 = Constraint(expr=   m.x316 - 2.87747432735804*m.b376 <= 0)

m.c407 = Constraint(expr=   m.x317 + 2.87747432735804*m.b376 <= 2.87747432735804)

m.c408 = Constraint(expr=   m.x324 - 2.15810574551853*m.b376 <= 0)

m.c409 = Constraint(expr=   m.x325 + 2.15810574551853*m.b376 <= 2.15810574551853)

m.c410 = Constraint(expr=(m.x326/(1e-6 + m.b377) - 1.5*log(1 + m.x318/(1e-6 + m.b377)))*(1e-6 + m.b377) <= 0)

m.c411 = Constraint(expr=   m.x319 == 0)

m.c412 = Constraint(expr=   m.x328 == 0)

m.c413 = Constraint(expr=   m.x277 - m.x318 - m.x319 == 0)

m.c414 = Constraint(expr=   m.x281 - m.x326 - m.x328 == 0)

m.c415 = Constraint(expr=   m.x318 - 2.87747432735804*m.b377 <= 0)

m.c416 = Constraint(expr=   m.x319 + 2.87747432735804*m.b377 <= 2.87747432735804)

m.c417 = Constraint(expr=   m.x326 - 2.03277599268042*m.b377 <= 0)

m.c418 = Constraint(expr=   m.x328 + 2.03277599268042*m.b377 <= 2.03277599268042)

m.c419 = Constraint(expr= - m.x320 + m.x330 == 0)

m.c420 = Constraint(expr= - 0.5*m.x322 + m.x330 == 0)

m.c421 = Constraint(expr=   m.x321 == 0)

m.c422 = Constraint(expr=   m.x323 == 0)

m.c423 = Constraint(expr=   m.x331 == 0)

m.c424 = Constraint(expr=   m.x278 - m.x320 - m.x321 == 0)

m.c425 = Constraint(expr=   m.x279 - m.x322 - m.x323 == 0)

m.c426 = Constraint(expr=   m.x282 - m.x330 - m.x331 == 0)

m.c427 = Constraint(expr=   m.x320 - 2.87747432735804*m.b378 <= 0)

m.c428 = Constraint(expr=   m.x321 + 2.87747432735804*m.b378 <= 2.87747432735804)

m.c429 = Constraint(expr=   m.x322 - 7*m.b378 <= 0)

m.c430 = Constraint(expr=   m.x323 + 7*m.b378 <= 7)

m.c431 = Constraint(expr=   m.x330 - 3.5*m.b378 <= 0)

m.c432 = Constraint(expr=   m.x331 + 3.5*m.b378 <= 3.5)

m.c433 = Constraint(expr=(m.x342/(1e-6 + m.b379) - 1.25*log(1 + m.x332/(1e-6 + m.b379)))*(1e-6 + m.b379) <= 0)

m.c434 = Constraint(expr=   m.x333 == 0)

m.c435 = Constraint(expr=   m.x344 == 0)

m.c436 = Constraint(expr=   m.x283 - m.x332 - m.x333 == 0)

m.c437 = Constraint(expr=   m.x288 - m.x342 - m.x344 == 0)

m.c438 = Constraint(expr=   m.x332 - 2.15810574551853*m.b379 <= 0)

m.c439 = Constraint(expr=   m.x333 + 2.15810574551853*m.b379 <= 2.15810574551853)

m.c440 = Constraint(expr=   m.x342 - 1.43746550029693*m.b379 <= 0)

m.c441 = Constraint(expr=   m.x344 + 1.43746550029693*m.b379 <= 1.43746550029693)

m.c442 = Constraint(expr=(m.x346/(1e-6 + m.b380) - 0.9*log(1 + m.x334/(1e-6 + m.b380)))*(1e-6 + m.b380) <= 0)

m.c443 = Constraint(expr=   m.x335 == 0)

m.c444 = Constraint(expr=   m.x348 == 0)

m.c445 = Constraint(expr=   m.x284 - m.x334 - m.x335 == 0)

m.c446 = Constraint(expr=   m.x289 - m.x346 - m.x348 == 0)

m.c447 = Constraint(expr=   m.x334 - 2.15810574551853*m.b380 <= 0)

m.c448 = Constraint(expr=   m.x335 + 2.15810574551853*m.b380 <= 2.15810574551853)

m.c449 = Constraint(expr=   m.x346 - 1.03497516021379*m.b380 <= 0)

m.c450 = Constraint(expr=   m.x348 + 1.03497516021379*m.b380 <= 1.03497516021379)

m.c451 = Constraint(expr=(m.x350/(1e-6 + m.b381) - log(1 + m.x327/(1e-6 + m.b381)))*(1e-6 + m.b381) <= 0)

m.c452 = Constraint(expr=   m.x329 == 0)

m.c453 = Constraint(expr=   m.x351 == 0)

m.c454 = Constraint(expr=   m.x281 - m.x327 - m.x329 == 0)

m.c455 = Constraint(expr=   m.x290 - m.x350 - m.x351 == 0)

m.c456 = Constraint(expr=   m.x327 - 2.03277599268042*m.b381 <= 0)

m.c457 = Constraint(expr=   m.x329 + 2.03277599268042*m.b381 <= 2.03277599268042)

m.c458 = Constraint(expr=   m.x350 - 1.10947836929589*m.b381 <= 0)

m.c459 = Constraint(expr=   m.x351 + 1.10947836929589*m.b381 <= 1.10947836929589)

m.c460 = Constraint(expr= - 0.9*m.x336 + m.x352 == 0)

m.c461 = Constraint(expr=   m.x337 == 0)

m.c462 = Constraint(expr=   m.x353 == 0)

m.c463 = Constraint(expr=   m.x285 - m.x336 - m.x337 == 0)

m.c464 = Constraint(expr=   m.x291 - m.x352 - m.x353 == 0)

m.c465 = Constraint(expr=   m.x336 - 3.5*m.b382 <= 0)

m.c466 = Constraint(expr=   m.x337 + 3.5*m.b382 <= 3.5)

m.c467 = Constraint(expr=   m.x352 - 3.15*m.b382 <= 0)

m.c468 = Constraint(expr=   m.x353 + 3.15*m.b382 <= 3.15)

m.c469 = Constraint(expr= - 0.6*m.x338 + m.x354 == 0)

m.c470 = Constraint(expr=   m.x339 == 0)

m.c471 = Constraint(expr=   m.x355 == 0)

m.c472 = Constraint(expr=   m.x286 - m.x338 - m.x339 == 0)

m.c473 = Constraint(expr=   m.x292 - m.x354 - m.x355 == 0)

m.c474 = Constraint(expr=   m.x338 - 3.5*m.b383 <= 0)

m.c475 = Constraint(expr=   m.x339 + 3.5*m.b383 <= 3.5)

m.c476 = Constraint(expr=   m.x354 - 2.1*m.b383 <= 0)

m.c477 = Constraint(expr=   m.x355 + 2.1*m.b383 <= 2.1)

m.c478 = Constraint(expr=(m.x356/(1e-6 + m.b384) - 1.1*log(1 + m.x340/(1e-6 + m.b384)))*(1e-6 + m.b384) <= 0)

m.c479 = Constraint(expr=   m.x341 == 0)

m.c480 = Constraint(expr=   m.x357 == 0)

m.c481 = Constraint(expr=   m.x287 - m.x340 - m.x341 == 0)

m.c482 = Constraint(expr=   m.x293 - m.x356 - m.x357 == 0)

m.c483 = Constraint(expr=   m.x340 - 3.5*m.b384 <= 0)

m.c484 = Constraint(expr=   m.x341 + 3.5*m.b384 <= 3.5)

m.c485 = Constraint(expr=   m.x356 - 1.6544851364539*m.b384 <= 0)

m.c486 = Constraint(expr=   m.x357 + 1.6544851364539*m.b384 <= 1.6544851364539)

m.c487 = Constraint(expr= - 0.9*m.x343 + m.x366 == 0)

m.c488 = Constraint(expr= - m.x362 + m.x366 == 0)

m.c489 = Constraint(expr=   m.x345 == 0)

m.c490 = Constraint(expr=   m.x363 == 0)

m.c491 = Constraint(expr=   m.x367 == 0)

m.c492 = Constraint(expr=   m.x288 - m.x343 - m.x345 == 0)

m.c493 = Constraint(expr=   m.x296 - m.x362 - m.x363 == 0)

m.c494 = Constraint(expr=   m.x304 - m.x366 - m.x367 == 0)

m.c495 = Constraint(expr=   m.x343 - 1.43746550029693*m.b385 <= 0)

m.c496 = Constraint(expr=   m.x345 + 1.43746550029693*m.b385 <= 1.43746550029693)

m.c497 = Constraint(expr=   m.x362 - 5*m.b385 <= 0)

m.c498 = Constraint(expr=   m.x363 + 5*m.b385 <= 5)

m.c499 = Constraint(expr=   m.x366 - 5*m.b385 <= 0)

m.c500 = Constraint(expr=   m.x367 + 5*m.b385 <= 5)

m.c501 = Constraint(expr=(m.x368/(1e-6 + m.b386) - log(1 + m.x347/(1e-6 + m.b386)))*(1e-6 + m.b386) <= 0)

m.c502 = Constraint(expr=   m.x349 == 0)

m.c503 = Constraint(expr=   m.x369 == 0)

m.c504 = Constraint(expr=   m.x289 - m.x347 - m.x349 == 0)

m.c505 = Constraint(expr=   m.x305 - m.x368 - m.x369 == 0)

m.c506 = Constraint(expr=   m.x347 - 1.03497516021379*m.b386 <= 0)

m.c507 = Constraint(expr=   m.x349 + 1.03497516021379*m.b386 <= 1.03497516021379)

m.c508 = Constraint(expr=   m.x368 - 0.710483612536911*m.b386 <= 0)

m.c509 = Constraint(expr=   m.x369 + 0.710483612536911*m.b386 <= 0.710483612536911)

m.c510 = Constraint(expr=(m.x370/(1e-6 + m.b387) - 0.7*log(1 + m.x358/(1e-6 + m.b387)))*(1e-6 + m.b387) <= 0)

m.c511 = Constraint(expr=   m.x359 == 0)

m.c512 = Constraint(expr=   m.x371 == 0)

m.c513 = Constraint(expr=   m.x294 - m.x358 - m.x359 == 0)

m.c514 = Constraint(expr=   m.x306 - m.x370 - m.x371 == 0)

m.c515 = Constraint(expr=   m.x358 - 1.10947836929589*m.b387 <= 0)

m.c516 = Constraint(expr=   m.x359 + 1.10947836929589*m.b387 <= 1.10947836929589)

m.c517 = Constraint(expr=   m.x370 - 0.522508489006913*m.b387 <= 0)

m.c518 = Constraint(expr=   m.x371 + 0.522508489006913*m.b387 <= 0.522508489006913)

m.c519 = Constraint(expr=(m.x372/(1e-6 + m.b388) - 0.65*log(1 + m.x360/(1e-6 + m.b388)))*(1e-6 + m.b388) <= 0)

m.c520 = Constraint(expr=(m.x372/(1e-6 + m.b388) - 0.65*log(1 + m.x364/(1e-6 + m.b388)))*(1e-6 + m.b388) <= 0)

m.c521 = Constraint(expr=   m.x361 == 0)

m.c522 = Constraint(expr=   m.x365 == 0)

m.c523 = Constraint(expr=   m.x373 == 0)

m.c524 = Constraint(expr=   m.x295 - m.x360 - m.x361 == 0)

m.c525 = Constraint(expr=   m.x298 - m.x364 - m.x365 == 0)

m.c526 = Constraint(expr=   m.x307 - m.x372 - m.x373 == 0)

m.c527 = Constraint(expr=   m.x360 - 1.10947836929589*m.b388 <= 0)

m.c528 = Constraint(expr=   m.x361 + 1.10947836929589*m.b388 <= 1.10947836929589)

m.c529 = Constraint(expr=   m.x364 - 8.15*m.b388 <= 0)

m.c530 = Constraint(expr=   m.x365 + 8.15*m.b388 <= 8.15)

m.c531 = Constraint(expr=   m.x372 - 1.43894002153683*m.b388 <= 0)

m.c532 = Constraint(expr=   m.x373 + 1.43894002153683*m.b388 <= 1.43894002153683)

m.c533 = Constraint(expr=   m.b374 + m.b375 == 1)

m.c534 = Constraint(expr= - m.b376 + m.b379 + m.b380 >= 0)

m.c535 = Constraint(expr= - m.b379 + m.b385 >= 0)

m.c536 = Constraint(expr= - m.b380 + m.b386 >= 0)

m.c537 = Constraint(expr= - m.b377 + m.b381 >= 0)

m.c538 = Constraint(expr= - m.b381 + m.b387 + m.b388 >= 0)

m.c539 = Constraint(expr= - m.b378 + m.b382 + m.b383 + m.b384 >= 0)

m.c540 = Constraint(expr= - m.b382 + m.b388 >= 0)

m.c541 = Constraint(expr=   m.b374 + m.b375 - m.b376 >= 0)

m.c542 = Constraint(expr=   m.b374 + m.b375 - m.b377 >= 0)

m.c543 = Constraint(expr=   m.b374 + m.b375 - m.b378 >= 0)

m.c544 = Constraint(expr=   m.b376 - m.b379 >= 0)

m.c545 = Constraint(expr=   m.b376 - m.b380 >= 0)

m.c546 = Constraint(expr=   m.b377 - m.b381 >= 0)

m.c547 = Constraint(expr=   m.b378 - m.b382 >= 0)

m.c548 = Constraint(expr=   m.b378 - m.b383 >= 0)

m.c549 = Constraint(expr=   m.b378 - m.b384 >= 0)

m.c550 = Constraint(expr=   m.b379 - m.b385 >= 0)

m.c551 = Constraint(expr=   m.b380 - m.b386 >= 0)

m.c552 = Constraint(expr=   m.b381 - m.b387 >= 0)

m.c553 = Constraint(expr=   m.b381 - m.b388 >= 0)
