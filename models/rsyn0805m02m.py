...
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        770      161      178      431        0        0        0        0
#  
#  Variable counts
#                   x        b        i      s1s      s2s       sc       si
#      Total     cont   binary  integer     sos1     sos2    scont     sint
#        361      213      148        0        0        0        0        0
#  FX      0        0        0        0        0        0        0        0
#  
#  Nonzero counts
#      Total    const       NL      DLL
...
m.obj = Objective(expr= - 20*m.x2 - 17*m.x3 - 20*m.x12 - 21*m.x13 - 18*m.x20 - 20*m.x21 - 16*m.x44 - 19*m.x45 + 26*m.x52
                        ...
                        - 2*m.x324 - m.x325 + 80*m.x326 + 90*m.x327 + 285*m.x328 + 390*m.x329 + 290*m.x330 + 405*m.x331
                        - 5*m.b342 - 4*m.b343 - 8*m.b344 - 7*m.b345 - 6*m.b346 - 9*m.b347 - 10*m.b348 - 9*m.b349
                        - 6*m.b350 - 10*m.b351, sense=maximize)
...
m.c678 = Constraint(expr=-log(1 + m.x304) + m.x308 + m.b332 <= 1)

m.c679 = Constraint(expr=-log(1 + m.x305) + m.x309 + m.b333 <= 1)

m.c680 = Constraint(expr=   m.x304 - 40*m.b332 <= 0)

m.c681 = Constraint(expr=   m.x305 - 40*m.b333 <= 0)

m.c682 = Constraint(expr=   m.x308 - 3.71357206670431*m.b332 <= 0)

m.c683 = Constraint(expr=   m.x309 - 3.71357206670431*m.b333 <= 0)

m.c684 = Constraint(expr=-1.2*log(1 + m.x306) + m.x310 + m.b334 <= 1)

m.c685 = Constraint(expr=-1.2*log(1 + m.x307) + m.x311 + m.b335 <= 1)

m.c686 = Constraint(expr=   m.x306 - 40*m.b334 <= 0)

m.c687 = Constraint(expr=   m.x307 - 40*m.b335 <= 0)

m.c688 = Constraint(expr=   m.x310 - 4.45628648004517*m.b334 <= 0)

m.c689 = Constraint(expr=   m.x311 - 4.45628648004517*m.b335 <= 0)

m.c690 = Constraint(expr= - 0.75*m.x318 + m.x326 + m.b336 <= 1)

m.c691 = Constraint(expr= - 0.75*m.x319 + m.x327 + m.b337 <= 1)

m.c692 = Constraint(expr= - 0.75*m.x318 + m.x326 - m.b336 >= -1)

m.c693 = Constraint(expr= - 0.75*m.x319 + m.x327 - m.b337 >= -1)

m.c694 = Constraint(expr=   m.x318 - 4.45628648004517*m.b336 <= 0)

m.c695 = Constraint(expr=   m.x319 - 4.45628648004517*m.b337 <= 0)

m.c696 = Constraint(expr=   m.x326 - 3.34221486003388*m.b336 <= 0)

m.c697 = Constraint(expr=   m.x327 - 3.34221486003388*m.b337 <= 0)

m.c698 = Constraint(expr=-1.5*log(1 + m.x320) + m.x328 + m.b338 <= 1)

m.c699 = Constraint(expr=-1.5*log(1 + m.x321) + m.x329 + m.b339 <= 1)

m.c700 = Constraint(expr=   m.x320 - 4.45628648004517*m.b338 <= 0)

m.c701 = Constraint(expr=   m.x321 - 4.45628648004517*m.b339 <= 0)

m.c702 = Constraint(expr=   m.x328 - 2.54515263975353*m.b338 <= 0)

m.c703 = Constraint(expr=   m.x329 - 2.54515263975353*m.b339 <= 0)

m.c704 = Constraint(expr= - m.x322 + m.x330 + m.b340 <= 1)

m.c705 = Constraint(expr= - m.x323 + m.x331 + m.b341 <= 1)

m.c706 = Constraint(expr= - m.x322 + m.x330 - m.b340 >= -1)

m.c707 = Constraint(expr= - m.x323 + m.x331 - m.b341 >= -1)

m.c708 = Constraint(expr= - 0.5*m.x324 + m.x330 + m.b340 <= 1)

m.c709 = Constraint(expr= - 0.5*m.x325 + m.x331 + m.b341 <= 1)

m.c710 = Constraint(expr= - 0.5*m.x324 + m.x330 - m.b340 >= -1)

m.c711 = Constraint(expr= - 0.5*m.x325 + m.x331 - m.b341 >= -1)

m.c712 = Constraint(expr=   m.x322 - 4.45628648004517*m.b340 <= 0)

m.c713 = Constraint(expr=   m.x323 - 4.45628648004517*m.b341 <= 0)

m.c714 = Constraint(expr=   m.x324 - 30*m.b340 <= 0)

m.c715 = Constraint(expr=   m.x325 - 30*m.b341 <= 0)

m.c716 = Constraint(expr=   m.x330 - 15*m.b340 <= 0)

m.c717 = Constraint(expr=   m.x331 - 15*m.b341 <= 0)

m.c718 = Constraint(expr=   5*m.b342 + m.x352 <= 0)

m.c719 = Constraint(expr=   4*m.b343 + m.x353 <= 0)

m.c720 = Constraint(expr=   8*m.b344 + m.x354 <= 0)

m.c721 = Constraint(expr=   7*m.b345 + m.x355 <= 0)

m.c722 = Constraint(expr=   6*m.b346 + m.x356 <= 0)

m.c723 = Constraint(expr=   9*m.b347 + m.x357 <= 0)

m.c724 = Constraint(expr=   10*m.b348 + m.x358 <= 0)

m.c725 = Constraint(expr=   9*m.b349 + m.x359 <= 0)

m.c726 = Constraint(expr=   6*m.b350 + m.x360 <= 0)

m.c727 = Constraint(expr=   10*m.b351 + m.x361 <= 0)

m.c728 = Constraint(expr=   5*m.b342 + m.x352 >= 0)

m.c729 = Constraint(expr=   4*m.b343 + m.x353 >= 0)

m.c730 = Constraint(expr=   8*m.b344 + m.x354 >= 0)

m.c731 = Constraint(expr=   7*m.b345 + m.x355 >= 0)

m.c732 = Constraint(expr=   6*m.b346 + m.x356 >= 0)

m.c733 = Constraint(expr=   9*m.b347 + m.x357 >= 0)

m.c734 = Constraint(expr=   10*m.b348 + m.x358 >= 0)

m.c735 = Constraint(expr=   9*m.b349 + m.x359 >= 0)

m.c736 = Constraint(expr=   6*m.b350 + m.x360 >= 0)

m.c737 = Constraint(expr=   10*m.b351 + m.x361 >= 0)

m.c738 = Constraint(expr=   m.b332 - m.b333 <= 0)

m.c739 = Constraint(expr=   m.b334 - m.b335 <= 0)

m.c740 = Constraint(expr=   m.b336 - m.b337 <= 0)

m.c741 = Constraint(expr=   m.b338 - m.b339 <= 0)

m.c742 = Constraint(expr=   m.b340 - m.b341 <= 0)

m.c743 = Constraint(expr=   m.b342 + m.b343 <= 1)

m.c744 = Constraint(expr=   m.b342 + m.b343 <= 1)

m.c745 = Constraint(expr=   m.b344 + m.b345 <= 1)

m.c746 = Constraint(expr=   m.b344 + m.b345 <= 1)

m.c747 = Constraint(expr=   m.b346 + m.b347 <= 1)

m.c748 = Constraint(expr=   m.b346 + m.b347 <= 1)

m.c749 = Constraint(expr=   m.b348 + m.b349 <= 1)

m.c750 = Constraint(expr=   m.b348 + m.b349 <= 1)

m.c751 = Constraint(expr=   m.b350 + m.b351 <= 1)

m.c752 = Constraint(expr=   m.b350 + m.b351 <= 1)

m.c753 = Constraint(expr=   m.b332 - m.b342 <= 0)

m.c754 = Constraint(expr= - m.b332 + m.b333 - m.b343 <= 0)

m.c755 = Constraint(expr=   m.b334 - m.b344 <= 0)

m.c756 = Constraint(expr= - m.b334 + m.b335 - m.b345 <= 0)

m.c757 = Constraint(expr=   m.b336 - m.b346 <= 0)

m.c758 = Constraint(expr= - m.b336 + m.b337 - m.b347 <= 0)

m.c759 = Constraint(expr=   m.b338 - m.b348 <= 0)

m.c760 = Constraint(expr= - m.b338 + m.b339 - m.b349 <= 0)

m.c761 = Constraint(expr=   m.b340 - m.b350 <= 0)

m.c762 = Constraint(expr= - m.b340 + m.b341 - m.b351 <= 0)

m.c763 = Constraint(expr=   m.b332 + m.b334 == 1)

m.c764 = Constraint(expr=   m.b333 + m.b335 == 1)

m.c765 = Constraint(expr=   m.b332 + m.b334 - m.b336 >= 0)

m.c766 = Constraint(expr=   m.b333 + m.b335 - m.b337 >= 0)

m.c767 = Constraint(expr=   m.b332 + m.b334 - m.b338 >= 0)

m.c768 = Constraint(expr=   m.b333 + m.b335 - m.b339 >= 0)

m.c769 = Constraint(expr=   m.b332 + m.b334 - m.b340 >= 0)

m.c770 = Constraint(expr=   m.b333 + m.b335 - m.b341 >= 0)
