...
m.obj = Objective(expr= - 4*m.x2 - 8*m.x7 - 5*m.x11 - 8*m.x23 + 23*m.x27 + 19*m.x29 - 10*m.x30 + 2*m.x33 + 3*m.x34
                        ...
                        - 15*m.b266 - 23*m.b267 + 5*m.x274 - 2*m.x279 + 200*m.x287 + 250*m.x288 + 200*m.x289
                        + 200*m.x290 + 500*m.x291 + 350*m.x292 - 5*m.b335 - 8*m.b336 - 6*m.b337 - 10*m.b338 - 6*m.b339
                        - 7*m.b340 - 4*m.b341 - 5*m.b342 - 2*m.b343 - 4*m.b344, sense=maximize)
...
m.c379 = Constraint(expr=(m.x297/(1e-6 + m.b335) - log(1 + m.x293/(1e-6 + m.b335)))*(1e-6 + m.b335) <= 0)

m.c380 = Constraint(expr=   m.x294 == 0)

m.c381 = Constraint(expr=   m.x298 == 0)

m.c382 = Constraint(expr=   m.x269 - m.x293 - m.x294 == 0)

m.c383 = Constraint(expr=   m.x271 - m.x297 - m.x298 == 0)

m.c384 = Constraint(expr=   m.x293 - 10*m.b335 <= 0)

m.c385 = Constraint(expr=   m.x294 + 10*m.b335 <= 10)

m.c386 = Constraint(expr=   m.x297 - 2.39789527279837*m.b335 <= 0)

m.c387 = Constraint(expr=   m.x298 + 2.39789527279837*m.b335 <= 2.39789527279837)

m.c388 = Constraint(expr=(m.x299/(1e-6 + m.b336) - 1.2*log(1 + m.x295/(1e-6 + m.b336)))*(1e-6 + m.b336) <= 0)

m.c389 = Constraint(expr=   m.x296 == 0)

m.c390 = Constraint(expr=   m.x300 == 0)

m.c391 = Constraint(expr=   m.x270 - m.x295 - m.x296 == 0)

m.c392 = Constraint(expr=   m.x272 - m.x299 - m.x300 == 0)

m.c393 = Constraint(expr=   m.x295 - 10*m.b336 <= 0)

m.c394 = Constraint(expr=   m.x296 + 10*m.b336 <= 10)

m.c395 = Constraint(expr=   m.x299 - 2.87747432735804*m.b336 <= 0)

m.c396 = Constraint(expr=   m.x300 + 2.87747432735804*m.b336 <= 2.87747432735804)

m.c397 = Constraint(expr= - 0.75*m.x301 + m.x309 == 0)

m.c398 = Constraint(expr=   m.x302 == 0)

m.c399 = Constraint(expr=   m.x310 == 0)

m.c400 = Constraint(expr=   m.x276 - m.x301 - m.x302 == 0)

m.c401 = Constraint(expr=   m.x280 - m.x309 - m.x310 == 0)

m.c402 = Constraint(expr=   m.x301 - 2.87747432735804*m.b337 <= 0)

m.c403 = Constraint(expr=   m.x302 + 2.87747432735804*m.b337 <= 2.87747432735804)

m.c404 = Constraint(expr=   m.x309 - 2.15810574551853*m.b337 <= 0)

m.c405 = Constraint(expr=   m.x310 + 2.15810574551853*m.b337 <= 2.15810574551853)

m.c406 = Constraint(expr=(m.x311/(1e-6 + m.b338) - 1.5*log(1 + m.x303/(1e-6 + m.b338)))*(1e-6 + m.b338) <= 0)

m.c407 = Constraint(expr=   m.x304 == 0)

m.c408 = Constraint(expr=   m.x313 == 0)

m.c409 = Constraint(expr=   m.x277 - m.x303 - m.x304 == 0)

m.c410 = Constraint(expr=   m.x281 - m.x311 - m.x313 == 0)

m.c411 = Constraint(expr=   m.x303 - 2.87747432735804*m.b338 <= 0)

m.c412 = Constraint(expr=   m.x304 + 2.87747432735804*m.b338 <= 2.87747432735804)

m.c413 = Constraint(expr=   m.x311 - 2.03277599268042*m.b338 <= 0)

m.c414 = Constraint(expr=   m.x313 + 2.03277599268042*m.b338 <= 2.03277599268042)

m.c415 = Constraint(expr= - m.x305 + m.x315 == 0)

m.c416 = Constraint(expr= - 0.5*m.x307 + m.x315 == 0)

m.c417 = Constraint(expr=   m.x306 == 0)

m.c418 = Constraint(expr=   m.x308 == 0)

m.c419 = Constraint(expr=   m.x316 == 0)

m.c420 = Constraint(expr=   m.x278 - m.x305 - m.x306 == 0)

m.c421 = Constraint(expr=   m.x279 - m.x307 - m.x308 == 0)

m.c422 = Constraint(expr=   m.x282 - m.x315 - m.x316 == 0)

m.c423 = Constraint(expr=   m.x305 - 2.87747432735804*m.b339 <= 0)

m.c424 = Constraint(expr=   m.x306 + 2.87747432735804*m.b339 <= 2.87747432735804)

m.c425 = Constraint(expr=   m.x307 - 7*m.b339 <= 0)

m.c426 = Constraint(expr=   m.x308 + 7*m.b339 <= 7)

m.c427 = Constraint(expr=   m.x315 - 3.5*m.b339 <= 0)

m.c428 = Constraint(expr=   m.x316 + 3.5*m.b339 <= 3.5)

m.c429 = Constraint(expr=(m.x325/(1e-6 + m.b340) - 1.25*log(1 + m.x317/(1e-6 + m.b340)))*(1e-6 + m.b340) <= 0)

m.c430 = Constraint(expr=   m.x318 == 0)

m.c431 = Constraint(expr=   m.x326 == 0)

m.c432 = Constraint(expr=   m.x283 - m.x317 - m.x318 == 0)

m.c433 = Constraint(expr=   m.x288 - m.x325 - m.x326 == 0)

m.c434 = Constraint(expr=   m.x317 - 2.15810574551853*m.b340 <= 0)

m.c435 = Constraint(expr=   m.x318 + 2.15810574551853*m.b340 <= 2.15810574551853)

m.c436 = Constraint(expr=   m.x325 - 1.43746550029693*m.b340 <= 0)

m.c437 = Constraint(expr=   m.x326 + 1.43746550029693*m.b340 <= 1.43746550029693)

m.c438 = Constraint(expr=(m.x327/(1e-6 + m.b341) - 0.9*log(1 + m.x319/(1e-6 + m.b341)))*(1e-6 + m.b341) <= 0)

m.c439 = Constraint(expr=   m.x320 == 0)

m.c440 = Constraint(expr=   m.x328 == 0)

m.c441 = Constraint(expr=   m.x284 - m.x319 - m.x320 == 0)

m.c442 = Constraint(expr=   m.x289 - m.x327 - m.x328 == 0)

m.c443 = Constraint(expr=   m.x319 - 2.15810574551853*m.b341 <= 0)

m.c444 = Constraint(expr=   m.x320 + 2.15810574551853*m.b341 <= 2.15810574551853)

m.c445 = Constraint(expr=   m.x327 - 1.03497516021379*m.b341 <= 0)

m.c446 = Constraint(expr=   m.x328 + 1.03497516021379*m.b341 <= 1.03497516021379)

m.c447 = Constraint(expr=(m.x329/(1e-6 + m.b342) - log(1 + m.x312/(1e-6 + m.b342)))*(1e-6 + m.b342) <= 0)

m.c448 = Constraint(expr=   m.x314 == 0)

m.c449 = Constraint(expr=   m.x330 == 0)

m.c450 = Constraint(expr=   m.x281 - m.x312 - m.x314 == 0)

m.c451 = Constraint(expr=   m.x290 - m.x329 - m.x330 == 0)

m.c452 = Constraint(expr=   m.x312 - 2.03277599268042*m.b342 <= 0)

m.c453 = Constraint(expr=   m.x314 + 2.03277599268042*m.b342 <= 2.03277599268042)

m.c454 = Constraint(expr=   m.x329 - 1.10947836929589*m.b342 <= 0)

m.c455 = Constraint(expr=   m.x330 + 1.10947836929589*m.b342 <= 1.10947836929589)

m.c456 = Constraint(expr= - 0.9*m.x321 + m.x331 == 0)

m.c457 = Constraint(expr=   m.x322 == 0)

m.c458 = Constraint(expr=   m.x332 == 0)

m.c459 = Constraint(expr=   m.x285 - m.x321 - m.x322 == 0)

m.c460 = Constraint(expr=   m.x291 - m.x331 - m.x332 == 0)

m.c461 = Constraint(expr=   m.x321 - 3.5*m.b343 <= 0)

m.c462 = Constraint(expr=   m.x322 + 3.5*m.b343 <= 3.5)

m.c463 = Constraint(expr=   m.x331 - 3.15*m.b343 <= 0)

m.c464 = Constraint(expr=   m.x332 + 3.15*m.b343 <= 3.15)

m.c465 = Constraint(expr= - 0.6*m.x323 + m.x333 == 0)

m.c466 = Constraint(expr=   m.x324 == 0)

m.c467 = Constraint(expr=   m.x334 == 0)

m.c468 = Constraint(expr=   m.x286 - m.x323 - m.x324 == 0)

m.c469 = Constraint(expr=   m.x292 - m.x333 - m.x334 == 0)

m.c470 = Constraint(expr=   m.x323 - 3.5*m.b344 <= 0)

m.c471 = Constraint(expr=   m.x324 + 3.5*m.b344 <= 3.5)

m.c472 = Constraint(expr=   m.x333 - 2.1*m.b344 <= 0)

m.c473 = Constraint(expr=   m.x334 + 2.1*m.b344 <= 2.1)

m.c474 = Constraint(expr=   m.b335 + m.b336 == 1)

m.c475 = Constraint(expr= - m.b337 + m.b340 + m.b341 >= 0)

m.c476 = Constraint(expr= - m.b338 + m.b342 >= 0)

m.c477 = Constraint(expr=   m.b335 + m.b336 - m.b337 >= 0)

m.c478 = Constraint(expr=   m.b335 + m.b336 - m.b338 >= 0)

m.c479 = Constraint(expr=   m.b335 + m.b336 - m.b339 >= 0)

m.c480 = Constraint(expr=   m.b337 - m.b340 >= 0)

m.c481 = Constraint(expr=   m.b337 - m.b341 >= 0)

m.c482 = Constraint(expr=   m.b338 - m.b342 >= 0)

m.c483 = Constraint(expr=   m.b339 - m.b343 >= 0)

m.c484 = Constraint(expr=   m.b339 - m.b344 >= 0)
