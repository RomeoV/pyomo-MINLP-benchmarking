...
m.x77 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x78 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x79 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x80 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x81 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x82 = Var(within=Reals,bounds=(2,8),initialize=2)
m.x83 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x84 = Var(within=Reals,bounds=(3,11.31),initialize=3)
m.x85 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x86 = Var(within=Reals,bounds=(3.183,12),initialize=3.183)
m.x87 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x88 = Var(within=Reals,bounds=(3,11.31),initialize=3)
m.x89 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x90 = Var(within=Reals,bounds=(3.183,12),initialize=3.183)
m.x91 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x92 = Var(within=Reals,bounds=(1.5,6),initialize=1.5)
m.x93 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x94 = Var(within=Reals,bounds=(1.5,6),initialize=1.5)
m.x95 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x96 = Var(within=Reals,bounds=(1.5,6),initialize=1.5)
...
m.x102 = Var(within=Reals,bounds=(1.5,6),initialize=1.5)
...
m.c61 = Constraint(expr= - 0.5*m.x76 - 0.125*m.x78 <= -2)

m.c62 = Constraint(expr= - 0.125*m.x76 - 0.5*m.x78 <= -2)

m.c63 = Constraint(expr= - 0.5*m.x77 - 0.125*m.x79 <= -2)

m.c64 = Constraint(expr= - 0.125*m.x77 - 0.5*m.x79 <= -2)

m.c65 = Constraint(expr= - 0.5*m.x80 - 0.125*m.x82 <= -2)

m.c66 = Constraint(expr= - 0.125*m.x80 - 0.5*m.x82 <= -2)

m.c67 = Constraint(expr= - 0.333333*m.x84 - 0.083333*m.x86 <= -2)

m.c68 = Constraint(expr= - 0.088417*m.x84 - 0.314167*m.x86 <= -2)

m.c69 = Constraint(expr= - 0.333333*m.x88 - 0.083333*m.x90 <= -2)

m.c70 = Constraint(expr= - 0.088417*m.x88 - 0.314167*m.x90 <= -2)

m.c71 = Constraint(expr= - 0.666667*m.x92 - 0.166667*m.x94 <= -2)

m.c72 = Constraint(expr= - 0.166667*m.x92 - 0.666667*m.x94 <= -2)

m.c73 = Constraint(expr= - 0.666667*m.x96 - 0.166667*m.x98 <= -2)

m.c74 = Constraint(expr= - 0.166667*m.x96 - 0.666667*m.x98 <= -2)

m.c75 = Constraint(expr= - 0.666667*m.x100 - 0.166667*m.x102 <= -2)

m.c76 = Constraint(expr= - 0.166667*m.x100 - 0.666667*m.x102 <= -2)
