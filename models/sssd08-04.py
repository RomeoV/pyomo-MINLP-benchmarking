#  MINLP written by GAMS Convert at 05/10/19 14:22:55
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         41       13        0       28        0        0        0        0
...
m.c30 = Constraint(expr=-m.x45/(1 + m.x45) + m.x49 <= 0)

m.c31 = Constraint(expr=-m.x45/(1 + m.x45) + m.x50 <= 0)

m.c32 = Constraint(expr=-m.x45/(1 + m.x45) + m.x51 <= 0)

m.c33 = Constraint(expr=-m.x46/(1 + m.x46) + m.x52 <= 0)

m.c34 = Constraint(expr=-m.x46/(1 + m.x46) + m.x53 <= 0)

m.c35 = Constraint(expr=-m.x46/(1 + m.x46) + m.x54 <= 0)

m.c36 = Constraint(expr=-m.x47/(1 + m.x47) + m.x55 <= 0)

m.c37 = Constraint(expr=-m.x47/(1 + m.x47) + m.x56 <= 0)

m.c38 = Constraint(expr=-m.x47/(1 + m.x47) + m.x57 <= 0)

m.c39 = Constraint(expr=-m.x48/(1 + m.x48) + m.x58 <= 0)

m.c40 = Constraint(expr=-m.x48/(1 + m.x48) + m.x59 <= 0)

m.c41 = Constraint(expr=-m.x48/(1 + m.x48) + m.x60 <= 0)
