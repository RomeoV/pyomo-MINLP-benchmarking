...
m.obj = Objective(expr= - 10*m.x2 - 15*m.x7 - 18*m.x11 - 19*m.x23 + 35*m.x27 + 28*m.x29 - 16*m.x30 + 2*m.x33 + 3*m.x34
                        ...
                        + 80*m.x216 + 285*m.x217 + 290*m.x218 + 280*m.x219 + 290*m.x220 + 350*m.x221 - 5*m.b222
                        - 8*m.b223 - 6*m.b224 - 10*m.b225 - 6*m.b226 - 7*m.b227 - 4*m.b228 - 5*m.b229 - 2*m.b230
                        - 4*m.b231 - 3*m.b232 - 7*m.b233 - 3*m.b234 - 2*m.b235 - 4*m.b236 - 2*m.b237 - 3*m.b238
                        - 5*m.b239 - 2*m.b240 - m.b241 - 2*m.b242 - 9*m.b243 - 5*m.b244 - 2*m.b245 - 10*m.b246
                        - 4*m.b247 - 7*m.b248 - 4*m.b249 - 2*m.b250 - 8*m.b251, sense=maximize)
...
m.c277 = Constraint(expr=-log(1 + m.x153) + m.x155 + m.b222 <= 1)

m.c278 = Constraint(expr=   m.x153 - 40*m.b222 <= 0)

m.c279 = Constraint(expr=   m.x155 - 3.71357206670431*m.b222 <= 0)

m.c280 = Constraint(expr=-1.2*log(1 + m.x154) + m.x156 + m.b223 <= 1)

m.c281 = Constraint(expr=   m.x154 - 40*m.b223 <= 0)

m.c282 = Constraint(expr=   m.x156 - 4.45628648004517*m.b223 <= 0)

m.c283 = Constraint(expr= - 0.75*m.x160 + m.x164 + m.b224 <= 1)

m.c284 = Constraint(expr= - 0.75*m.x160 + m.x164 - m.b224 >= -1)

m.c285 = Constraint(expr=   m.x160 - 4.45628648004517*m.b224 <= 0)

m.c286 = Constraint(expr=   m.x164 - 3.34221486003388*m.b224 <= 0)

m.c287 = Constraint(expr=-1.5*log(1 + m.x161) + m.x165 + m.b225 <= 1)

m.c288 = Constraint(expr=   m.x161 - 4.45628648004517*m.b225 <= 0)

m.c289 = Constraint(expr=   m.x165 - 2.54515263975353*m.b225 <= 0)

m.c290 = Constraint(expr= - m.x162 + m.x166 + m.b226 <= 1)

m.c291 = Constraint(expr= - m.x162 + m.x166 - m.b226 >= -1)

m.c292 = Constraint(expr= - 0.5*m.x163 + m.x166 + m.b226 <= 1)

m.c293 = Constraint(expr= - 0.5*m.x163 + m.x166 - m.b226 >= -1)

m.c294 = Constraint(expr=   m.x162 - 4.45628648004517*m.b226 <= 0)

m.c295 = Constraint(expr=   m.x163 - 30*m.b226 <= 0)

m.c296 = Constraint(expr=   m.x166 - 15*m.b226 <= 0)

m.c297 = Constraint(expr=-1.25*log(1 + m.x167) + m.x172 + m.b227 <= 1)

m.c298 = Constraint(expr=   m.x167 - 3.34221486003388*m.b227 <= 0)

m.c299 = Constraint(expr=   m.x172 - 1.83548069293539*m.b227 <= 0)

m.c300 = Constraint(expr=-0.9*log(1 + m.x168) + m.x173 + m.b228 <= 1)

m.c301 = Constraint(expr=   m.x168 - 3.34221486003388*m.b228 <= 0)

m.c302 = Constraint(expr=   m.x173 - 1.32154609891348*m.b228 <= 0)

m.c303 = Constraint(expr=-log(1 + m.x165) + m.x174 + m.b229 <= 1)

m.c304 = Constraint(expr=   m.x165 - 2.54515263975353*m.b229 <= 0)

m.c305 = Constraint(expr=   m.x174 - 1.26558121681553*m.b229 <= 0)

m.c306 = Constraint(expr= - 0.9*m.x169 + m.x175 + m.b230 <= 1)

m.c307 = Constraint(expr= - 0.9*m.x169 + m.x175 - m.b230 >= -1)

m.c308 = Constraint(expr=   m.x169 - 15*m.b230 <= 0)

m.c309 = Constraint(expr=   m.x175 - 13.5*m.b230 <= 0)

m.c310 = Constraint(expr= - 0.6*m.x170 + m.x176 + m.b231 <= 1)

m.c311 = Constraint(expr= - 0.6*m.x170 + m.x176 - m.b231 >= -1)

m.c312 = Constraint(expr=   m.x170 - 15*m.b231 <= 0)

m.c313 = Constraint(expr=   m.x176 - 9*m.b231 <= 0)

m.c314 = Constraint(expr=-1.1*log(1 + m.x171) + m.x177 + m.b232 <= 1)

m.c315 = Constraint(expr=   m.x171 - 15*m.b232 <= 0)

m.c316 = Constraint(expr=   m.x177 - 3.04984759446376*m.b232 <= 0)

m.c317 = Constraint(expr= - 0.9*m.x172 + m.x188 + m.b233 <= 1)

m.c318 = Constraint(expr= - 0.9*m.x172 + m.x188 - m.b233 >= -1)

m.c319 = Constraint(expr= - m.x180 + m.x188 + m.b233 <= 1)

m.c320 = Constraint(expr= - m.x180 + m.x188 - m.b233 >= -1)

m.c321 = Constraint(expr=   m.x172 - 1.83548069293539*m.b233 <= 0)

m.c322 = Constraint(expr=   m.x180 - 20*m.b233 <= 0)

m.c323 = Constraint(expr=   m.x188 - 20*m.b233 <= 0)

m.c324 = Constraint(expr=-log(1 + m.x173) + m.x189 + m.b234 <= 1)

m.c325 = Constraint(expr=   m.x173 - 1.32154609891348*m.b234 <= 0)

m.c326 = Constraint(expr=   m.x189 - 0.842233385663186*m.b234 <= 0)

m.c327 = Constraint(expr=-0.7*log(1 + m.x178) + m.x190 + m.b235 <= 1)

m.c328 = Constraint(expr=   m.x178 - 1.26558121681553*m.b235 <= 0)

m.c329 = Constraint(expr=   m.x190 - 0.572481933717686*m.b235 <= 0)

m.c330 = Constraint(expr=-0.65*log(1 + m.x179) + m.x191 + m.b236 <= 1)

m.c331 = Constraint(expr=-0.65*log(1 + m.x182) + m.x191 + m.b236 <= 1)

m.c332 = Constraint(expr=   m.x179 - 1.26558121681553*m.b236 <= 0)

m.c333 = Constraint(expr=   m.x182 - 33.5*m.b236 <= 0)

m.c334 = Constraint(expr=   m.x191 - 2.30162356062425*m.b236 <= 0)

m.c335 = Constraint(expr= - m.x183 + m.x192 + m.b237 <= 1)

m.c336 = Constraint(expr= - m.x183 + m.x192 - m.b237 >= -1)

m.c337 = Constraint(expr=   m.x183 - 9*m.b237 <= 0)

m.c338 = Constraint(expr=   m.x192 - 9*m.b237 <= 0)

m.c339 = Constraint(expr= - m.x184 + m.x193 + m.b238 <= 1)

m.c340 = Constraint(expr= - m.x184 + m.x193 - m.b238 >= -1)

m.c341 = Constraint(expr=   m.x184 - 9*m.b238 <= 0)

m.c342 = Constraint(expr=   m.x193 - 9*m.b238 <= 0)

m.c343 = Constraint(expr=-0.75*log(1 + m.x185) + m.x194 + m.b239 <= 1)

m.c344 = Constraint(expr=   m.x185 - 3.04984759446376*m.b239 <= 0)

m.c345 = Constraint(expr=   m.x194 - 1.04900943706034*m.b239 <= 0)

m.c346 = Constraint(expr=-0.8*log(1 + m.x186) + m.x195 + m.b240 <= 1)

m.c347 = Constraint(expr=   m.x186 - 3.04984759446376*m.b240 <= 0)

m.c348 = Constraint(expr=   m.x195 - 1.11894339953103*m.b240 <= 0)

m.c349 = Constraint(expr=-0.85*log(1 + m.x187) + m.x196 + m.b241 <= 1)

m.c350 = Constraint(expr=   m.x187 - 3.04984759446376*m.b241 <= 0)

m.c351 = Constraint(expr=   m.x196 - 1.18887736200171*m.b241 <= 0)

m.c352 = Constraint(expr=-log(1 + m.x198) + m.x200 + m.b242 <= 1)

m.c353 = Constraint(expr=   m.x198 - 1.18887736200171*m.b242 <= 0)

m.c354 = Constraint(expr=   m.x200 - 0.78338879230327*m.b242 <= 0)

m.c355 = Constraint(expr=-1.2*log(1 + m.x199) + m.x201 + m.b243 <= 1)

m.c356 = Constraint(expr=   m.x199 - 1.18887736200171*m.b243 <= 0)

m.c357 = Constraint(expr=   m.x201 - 0.940066550763924*m.b243 <= 0)

m.c358 = Constraint(expr= - 0.75*m.x205 + m.x209 + m.b244 <= 1)

m.c359 = Constraint(expr= - 0.75*m.x205 + m.x209 - m.b244 >= -1)

m.c360 = Constraint(expr=   m.x205 - 0.940066550763924*m.b244 <= 0)

m.c361 = Constraint(expr=   m.x209 - 0.705049913072943*m.b244 <= 0)

m.c362 = Constraint(expr=-1.5*log(1 + m.x206) + m.x210 + m.b245 <= 1)

m.c363 = Constraint(expr=   m.x206 - 0.940066550763924*m.b245 <= 0)

m.c364 = Constraint(expr=   m.x210 - 0.994083415506506*m.b245 <= 0)

m.c365 = Constraint(expr= - m.x207 + m.x211 + m.b246 <= 1)

m.c366 = Constraint(expr= - m.x207 + m.x211 - m.b246 >= -1)

m.c367 = Constraint(expr= - 0.5*m.x208 + m.x211 + m.b246 <= 1)

m.c368 = Constraint(expr= - 0.5*m.x208 + m.x211 - m.b246 >= -1)

m.c369 = Constraint(expr=   m.x207 - 0.940066550763924*m.b246 <= 0)

m.c370 = Constraint(expr=   m.x208 - 30*m.b246 <= 0)

m.c371 = Constraint(expr=   m.x211 - 15*m.b246 <= 0)

m.c372 = Constraint(expr=-1.25*log(1 + m.x212) + m.x217 + m.b247 <= 1)

m.c373 = Constraint(expr=   m.x212 - 0.705049913072943*m.b247 <= 0)

m.c374 = Constraint(expr=   m.x217 - 0.666992981045719*m.b247 <= 0)

m.c375 = Constraint(expr=-0.9*log(1 + m.x213) + m.x218 + m.b248 <= 1)

m.c376 = Constraint(expr=   m.x213 - 0.705049913072943*m.b248 <= 0)

m.c377 = Constraint(expr=   m.x218 - 0.480234946352917*m.b248 <= 0)

m.c378 = Constraint(expr=-log(1 + m.x210) + m.x219 + m.b249 <= 1)

m.c379 = Constraint(expr=   m.x210 - 0.994083415506506*m.b249 <= 0)

m.c380 = Constraint(expr=   m.x219 - 0.690184503917672*m.b249 <= 0)

m.c381 = Constraint(expr= - 0.9*m.x214 + m.x220 + m.b250 <= 1)

m.c382 = Constraint(expr= - 0.9*m.x214 + m.x220 - m.b250 >= -1)

m.c383 = Constraint(expr=   m.x214 - 15*m.b250 <= 0)

m.c384 = Constraint(expr=   m.x220 - 13.5*m.b250 <= 0)

m.c385 = Constraint(expr= - 0.6*m.x215 + m.x221 + m.b251 <= 1)

m.c386 = Constraint(expr= - 0.6*m.x215 + m.x221 - m.b251 >= -1)

m.c387 = Constraint(expr=   m.x215 - 15*m.b251 <= 0)

m.c388 = Constraint(expr=   m.x221 - 9*m.b251 <= 0)

m.c389 = Constraint(expr=   m.b222 + m.b223 == 1)

m.c390 = Constraint(expr= - m.b224 + m.b227 + m.b228 >= 0)

m.c391 = Constraint(expr= - m.b227 + m.b233 >= 0)

m.c392 = Constraint(expr= - m.b228 + m.b234 >= 0)

m.c393 = Constraint(expr= - m.b225 + m.b229 >= 0)

m.c394 = Constraint(expr= - m.b229 + m.b235 + m.b236 >= 0)

m.c395 = Constraint(expr= - m.b226 + m.b230 + m.b231 + m.b232 >= 0)

m.c396 = Constraint(expr= - m.b230 + m.b236 >= 0)

m.c397 = Constraint(expr= - m.b231 + m.b237 + m.b238 >= 0)

m.c398 = Constraint(expr= - m.b232 + m.b239 + m.b240 + m.b241 >= 0)

m.c399 = Constraint(expr=   m.b222 + m.b223 - m.b224 >= 0)

m.c400 = Constraint(expr=   m.b222 + m.b223 - m.b225 >= 0)

m.c401 = Constraint(expr=   m.b222 + m.b223 - m.b226 >= 0)

m.c402 = Constraint(expr=   m.b224 - m.b227 >= 0)

m.c403 = Constraint(expr=   m.b224 - m.b228 >= 0)

m.c404 = Constraint(expr=   m.b225 - m.b229 >= 0)

m.c405 = Constraint(expr=   m.b226 - m.b230 >= 0)

m.c406 = Constraint(expr=   m.b226 - m.b231 >= 0)

m.c407 = Constraint(expr=   m.b226 - m.b232 >= 0)

m.c408 = Constraint(expr=   m.b227 - m.b233 >= 0)

m.c409 = Constraint(expr=   m.b228 - m.b234 >= 0)

m.c410 = Constraint(expr=   m.b229 - m.b235 >= 0)

m.c411 = Constraint(expr=   m.b229 - m.b236 >= 0)

m.c412 = Constraint(expr=   m.b231 - m.b237 >= 0)

m.c413 = Constraint(expr=   m.b231 - m.b238 >= 0)

m.c414 = Constraint(expr=   m.b232 - m.b239 >= 0)

m.c415 = Constraint(expr=   m.b232 - m.b240 >= 0)

m.c416 = Constraint(expr=   m.b232 - m.b241 >= 0)

m.c417 = Constraint(expr= - m.b241 + m.b242 + m.b243 >= 0)

m.c418 = Constraint(expr= - m.b244 + m.b247 + m.b248 >= 0)

m.c419 = Constraint(expr= - m.b245 + m.b249 >= 0)

m.c420 = Constraint(expr=   m.b241 - m.b242 >= 0)

m.c421 = Constraint(expr=   m.b241 - m.b243 >= 0)

m.c422 = Constraint(expr=   m.b244 - m.b247 >= 0)

m.c423 = Constraint(expr=   m.b244 - m.b248 >= 0)

m.c424 = Constraint(expr=   m.b245 - m.b249 >= 0)

m.c425 = Constraint(expr=   m.b246 - m.b250 >= 0)

m.c426 = Constraint(expr=   m.b246 - m.b251 >= 0)
