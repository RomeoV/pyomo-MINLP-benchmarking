...
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        372       79      114      179        0        0        0        0
#  
#  Variable counts
#                   x        b        i      s1s      s2s       sc       si
#      Total     cont   binary  integer     sos1     sos2    scont     sint
#        216      132       84        0        0        0        0        0
#  FX      0        0        0        0        0        0        0        0
#  
#  Nonzero counts
#      Total    const       NL      DLL
...
m.obj = Objective(expr= - 10*m.x2 - 15*m.x7 - 18*m.x11 - 19*m.x23 + 35*m.x27 + 28*m.x29 - 16*m.x30 + 2*m.x33 + 3*m.x34
                        ...
                        - 23*m.b119 + 5*m.x158 + 200*m.x188 + 250*m.x189 + 200*m.x190 + 700*m.x191 + 400*m.x192
                        + 500*m.x193 + 400*m.x194 + 600*m.x195 + 700*m.x196 - 5*m.b197 - 8*m.b198 - 6*m.b199 - 10*m.b200
                        - 6*m.b201 - 7*m.b202 - 4*m.b203 - 5*m.b204 - 2*m.b205 - 4*m.b206 - 3*m.b207 - 7*m.b208
                        - 3*m.b209 - 2*m.b210 - 4*m.b211 - 2*m.b212 - 3*m.b213 - 5*m.b214 - 2*m.b215 - 8*m.b216
                       , sense=maximize)
...
m.c270 = Constraint(expr=-log(1 + m.x153) + m.x155 + m.b197 <= 1)

m.c271 = Constraint(expr=   m.x153 - 10*m.b197 <= 0)

m.c272 = Constraint(expr=   m.x155 - 2.39789527279837*m.b197 <= 0)

m.c273 = Constraint(expr=-1.2*log(1 + m.x154) + m.x156 + m.b198 <= 1)

m.c274 = Constraint(expr=   m.x154 - 10*m.b198 <= 0)

m.c275 = Constraint(expr=   m.x156 - 2.87747432735804*m.b198 <= 0)

m.c276 = Constraint(expr= - 0.75*m.x160 + m.x164 + m.b199 <= 1)

m.c277 = Constraint(expr= - 0.75*m.x160 + m.x164 - m.b199 >= -1)

m.c278 = Constraint(expr=   m.x160 - 2.87747432735804*m.b199 <= 0)

m.c279 = Constraint(expr=   m.x164 - 2.15810574551853*m.b199 <= 0)

m.c280 = Constraint(expr=-1.5*log(1 + m.x161) + m.x165 + m.b200 <= 1)

m.c281 = Constraint(expr=   m.x161 - 2.87747432735804*m.b200 <= 0)

m.c282 = Constraint(expr=   m.x165 - 2.03277599268042*m.b200 <= 0)

m.c283 = Constraint(expr= - m.x162 + m.x166 + m.b201 <= 1)

m.c284 = Constraint(expr= - m.x162 + m.x166 - m.b201 >= -1)

m.c285 = Constraint(expr= - 0.5*m.x163 + m.x166 + m.b201 <= 1)

m.c286 = Constraint(expr= - 0.5*m.x163 + m.x166 - m.b201 >= -1)

m.c287 = Constraint(expr=   m.x162 - 2.87747432735804*m.b201 <= 0)

m.c288 = Constraint(expr=   m.x163 - 7*m.b201 <= 0)

m.c289 = Constraint(expr=   m.x166 - 3.5*m.b201 <= 0)

m.c290 = Constraint(expr=-1.25*log(1 + m.x167) + m.x172 + m.b202 <= 1)

m.c291 = Constraint(expr=   m.x167 - 2.15810574551853*m.b202 <= 0)

m.c292 = Constraint(expr=   m.x172 - 1.43746550029693*m.b202 <= 0)

m.c293 = Constraint(expr=-0.9*log(1 + m.x168) + m.x173 + m.b203 <= 1)

m.c294 = Constraint(expr=   m.x168 - 2.15810574551853*m.b203 <= 0)

m.c295 = Constraint(expr=   m.x173 - 1.03497516021379*m.b203 <= 0)

m.c296 = Constraint(expr=-log(1 + m.x165) + m.x174 + m.b204 <= 1)

m.c297 = Constraint(expr=   m.x165 - 2.03277599268042*m.b204 <= 0)

m.c298 = Constraint(expr=   m.x174 - 1.10947836929589*m.b204 <= 0)

m.c299 = Constraint(expr= - 0.9*m.x169 + m.x175 + m.b205 <= 1)

m.c300 = Constraint(expr= - 0.9*m.x169 + m.x175 - m.b205 >= -1)

m.c301 = Constraint(expr=   m.x169 - 3.5*m.b205 <= 0)

m.c302 = Constraint(expr=   m.x175 - 3.15*m.b205 <= 0)

m.c303 = Constraint(expr= - 0.6*m.x170 + m.x176 + m.b206 <= 1)

m.c304 = Constraint(expr= - 0.6*m.x170 + m.x176 - m.b206 >= -1)

m.c305 = Constraint(expr=   m.x170 - 3.5*m.b206 <= 0)

m.c306 = Constraint(expr=   m.x176 - 2.1*m.b206 <= 0)

m.c307 = Constraint(expr=-1.1*log(1 + m.x171) + m.x177 + m.b207 <= 1)

m.c308 = Constraint(expr=   m.x171 - 3.5*m.b207 <= 0)

m.c309 = Constraint(expr=   m.x177 - 1.6544851364539*m.b207 <= 0)

m.c310 = Constraint(expr= - 0.9*m.x172 + m.x188 + m.b208 <= 1)

m.c311 = Constraint(expr= - 0.9*m.x172 + m.x188 - m.b208 >= -1)

m.c312 = Constraint(expr= - m.x180 + m.x188 + m.b208 <= 1)

m.c313 = Constraint(expr= - m.x180 + m.x188 - m.b208 >= -1)

m.c314 = Constraint(expr=   m.x172 - 1.43746550029693*m.b208 <= 0)

m.c315 = Constraint(expr=   m.x180 - 5*m.b208 <= 0)

m.c316 = Constraint(expr=   m.x188 - 5*m.b208 <= 0)

m.c317 = Constraint(expr=-log(1 + m.x173) + m.x189 + m.b209 <= 1)

m.c318 = Constraint(expr=   m.x173 - 1.03497516021379*m.b209 <= 0)

m.c319 = Constraint(expr=   m.x189 - 0.710483612536911*m.b209 <= 0)

m.c320 = Constraint(expr=-0.7*log(1 + m.x178) + m.x190 + m.b210 <= 1)

m.c321 = Constraint(expr=   m.x178 - 1.10947836929589*m.b210 <= 0)

m.c322 = Constraint(expr=   m.x190 - 0.522508489006913*m.b210 <= 0)

m.c323 = Constraint(expr=-0.65*log(1 + m.x179) + m.x191 + m.b211 <= 1)

m.c324 = Constraint(expr=-0.65*log(1 + m.x182) + m.x191 + m.b211 <= 1)

m.c325 = Constraint(expr=   m.x179 - 1.10947836929589*m.b211 <= 0)

m.c326 = Constraint(expr=   m.x182 - 8.15*m.b211 <= 0)

m.c327 = Constraint(expr=   m.x191 - 1.43894002153683*m.b211 <= 0)

m.c328 = Constraint(expr= - m.x183 + m.x192 + m.b212 <= 1)

m.c329 = Constraint(expr= - m.x183 + m.x192 - m.b212 >= -1)

m.c330 = Constraint(expr=   m.x183 - 2.1*m.b212 <= 0)

m.c331 = Constraint(expr=   m.x192 - 2.1*m.b212 <= 0)

m.c332 = Constraint(expr= - m.x184 + m.x193 + m.b213 <= 1)

m.c333 = Constraint(expr= - m.x184 + m.x193 - m.b213 >= -1)

m.c334 = Constraint(expr=   m.x184 - 2.1*m.b213 <= 0)

m.c335 = Constraint(expr=   m.x193 - 2.1*m.b213 <= 0)

m.c336 = Constraint(expr=-0.75*log(1 + m.x185) + m.x194 + m.b214 <= 1)

m.c337 = Constraint(expr=   m.x185 - 1.6544851364539*m.b214 <= 0)

m.c338 = Constraint(expr=   m.x194 - 0.732188035236726*m.b214 <= 0)

m.c339 = Constraint(expr=-0.8*log(1 + m.x186) + m.x195 + m.b215 <= 1)

m.c340 = Constraint(expr=   m.x186 - 1.6544851364539*m.b215 <= 0)

m.c341 = Constraint(expr=   m.x195 - 0.781000570919175*m.b215 <= 0)

m.c342 = Constraint(expr=-0.85*log(1 + m.x187) + m.x196 + m.b216 <= 1)

m.c343 = Constraint(expr=   m.x187 - 1.6544851364539*m.b216 <= 0)

m.c344 = Constraint(expr=   m.x196 - 0.829813106601623*m.b216 <= 0)

m.c345 = Constraint(expr=   m.b197 + m.b198 == 1)

m.c346 = Constraint(expr= - m.b199 + m.b202 + m.b203 >= 0)

m.c347 = Constraint(expr= - m.b202 + m.b208 >= 0)

m.c348 = Constraint(expr= - m.b203 + m.b209 >= 0)

m.c349 = Constraint(expr= - m.b200 + m.b204 >= 0)

m.c350 = Constraint(expr= - m.b204 + m.b210 + m.b211 >= 0)

m.c351 = Constraint(expr= - m.b201 + m.b205 + m.b206 + m.b207 >= 0)

m.c352 = Constraint(expr= - m.b205 + m.b211 >= 0)

m.c353 = Constraint(expr= - m.b206 + m.b212 + m.b213 >= 0)

m.c354 = Constraint(expr= - m.b207 + m.b214 + m.b215 + m.b216 >= 0)

m.c355 = Constraint(expr=   m.b197 + m.b198 - m.b199 >= 0)

m.c356 = Constraint(expr=   m.b197 + m.b198 - m.b200 >= 0)

m.c357 = Constraint(expr=   m.b197 + m.b198 - m.b201 >= 0)

m.c358 = Constraint(expr=   m.b199 - m.b202 >= 0)

m.c359 = Constraint(expr=   m.b199 - m.b203 >= 0)

m.c360 = Constraint(expr=   m.b200 - m.b204 >= 0)

m.c361 = Constraint(expr=   m.b201 - m.b205 >= 0)

m.c362 = Constraint(expr=   m.b201 - m.b206 >= 0)

m.c363 = Constraint(expr=   m.b201 - m.b207 >= 0)

m.c364 = Constraint(expr=   m.b202 - m.b208 >= 0)

m.c365 = Constraint(expr=   m.b203 - m.b209 >= 0)

m.c366 = Constraint(expr=   m.b204 - m.b210 >= 0)

m.c367 = Constraint(expr=   m.b204 - m.b211 >= 0)

m.c368 = Constraint(expr=   m.b206 - m.b212 >= 0)

m.c369 = Constraint(expr=   m.b206 - m.b213 >= 0)

m.c370 = Constraint(expr=   m.b207 - m.b214 >= 0)

m.c371 = Constraint(expr=   m.b207 - m.b215 >= 0)

m.c372 = Constraint(expr=   m.b207 - m.b216 >= 0)
