...
m.obj = Objective(expr= - 20*m.x2 - 17*m.x3 - 15*m.x4 - 20*m.x17 - 21*m.x18 - 19*m.x19 - 18*m.x29 - 20*m.x30 - 20*m.x31
                        ...
                        - m.x453 - m.x454 + 5*m.x470 + 10*m.x471 + 5*m.x472 - 2*m.x485 - m.x486 - 2*m.x487 + 80*m.x488
                        + 90*m.x489 + 120*m.x490 + 285*m.x491 + 390*m.x492 + 350*m.x493 + 290*m.x494 + 405*m.x495
                        + 190*m.x496 - 5*m.b512 - 4*m.b513 - 6*m.b514 - 8*m.b515 - 7*m.b516 - 6*m.b517 - 6*m.b518
                        - 9*m.b519 - 4*m.b520 - 10*m.b521 - 9*m.b522 - 5*m.b523 - 6*m.b524 - 10*m.b525 - 6*m.b526
                       , sense=maximize)
...
m.c1124 = Constraint(expr=-log(1 + m.x455) + m.x461 + m.b497 <= 1)

m.c1125 = Constraint(expr=-log(1 + m.x456) + m.x462 + m.b498 <= 1)

m.c1126 = Constraint(expr=-log(1 + m.x457) + m.x463 + m.b499 <= 1)

m.c1127 = Constraint(expr=   m.x455 - 40*m.b497 <= 0)

m.c1128 = Constraint(expr=   m.x456 - 40*m.b498 <= 0)

m.c1129 = Constraint(expr=   m.x457 - 40*m.b499 <= 0)

m.c1130 = Constraint(expr=   m.x461 - 3.71357206670431*m.b497 <= 0)

m.c1131 = Constraint(expr=   m.x462 - 3.71357206670431*m.b498 <= 0)

m.c1132 = Constraint(expr=   m.x463 - 3.71357206670431*m.b499 <= 0)

m.c1133 = Constraint(expr=-1.2*log(1 + m.x458) + m.x464 + m.b500 <= 1)

m.c1134 = Constraint(expr=-1.2*log(1 + m.x459) + m.x465 + m.b501 <= 1)

m.c1135 = Constraint(expr=-1.2*log(1 + m.x460) + m.x466 + m.b502 <= 1)

m.c1136 = Constraint(expr=   m.x458 - 40*m.b500 <= 0)

m.c1137 = Constraint(expr=   m.x459 - 40*m.b501 <= 0)

m.c1138 = Constraint(expr=   m.x460 - 40*m.b502 <= 0)

m.c1139 = Constraint(expr=   m.x464 - 4.45628648004517*m.b500 <= 0)

m.c1140 = Constraint(expr=   m.x465 - 4.45628648004517*m.b501 <= 0)

m.c1141 = Constraint(expr=   m.x466 - 4.45628648004517*m.b502 <= 0)

m.c1142 = Constraint(expr= - 0.75*m.x476 + m.x488 + m.b503 <= 1)

m.c1143 = Constraint(expr= - 0.75*m.x477 + m.x489 + m.b504 <= 1)

m.c1144 = Constraint(expr= - 0.75*m.x478 + m.x490 + m.b505 <= 1)

m.c1145 = Constraint(expr= - 0.75*m.x476 + m.x488 - m.b503 >= -1)

m.c1146 = Constraint(expr= - 0.75*m.x477 + m.x489 - m.b504 >= -1)

m.c1147 = Constraint(expr= - 0.75*m.x478 + m.x490 - m.b505 >= -1)

m.c1148 = Constraint(expr=   m.x476 - 4.45628648004517*m.b503 <= 0)

m.c1149 = Constraint(expr=   m.x477 - 4.45628648004517*m.b504 <= 0)

m.c1150 = Constraint(expr=   m.x478 - 4.45628648004517*m.b505 <= 0)

m.c1151 = Constraint(expr=   m.x488 - 3.34221486003388*m.b503 <= 0)

m.c1152 = Constraint(expr=   m.x489 - 3.34221486003388*m.b504 <= 0)

m.c1153 = Constraint(expr=   m.x490 - 3.34221486003388*m.b505 <= 0)

m.c1154 = Constraint(expr=-1.5*log(1 + m.x479) + m.x491 + m.b506 <= 1)

m.c1155 = Constraint(expr=-1.5*log(1 + m.x480) + m.x492 + m.b507 <= 1)

m.c1156 = Constraint(expr=-1.5*log(1 + m.x481) + m.x493 + m.b508 <= 1)

m.c1157 = Constraint(expr=   m.x479 - 4.45628648004517*m.b506 <= 0)

m.c1158 = Constraint(expr=   m.x480 - 4.45628648004517*m.b507 <= 0)

m.c1159 = Constraint(expr=   m.x481 - 4.45628648004517*m.b508 <= 0)

m.c1160 = Constraint(expr=   m.x491 - 2.54515263975353*m.b506 <= 0)

m.c1161 = Constraint(expr=   m.x492 - 2.54515263975353*m.b507 <= 0)

m.c1162 = Constraint(expr=   m.x493 - 2.54515263975353*m.b508 <= 0)

m.c1163 = Constraint(expr= - m.x482 + m.x494 + m.b509 <= 1)

m.c1164 = Constraint(expr= - m.x483 + m.x495 + m.b510 <= 1)

m.c1165 = Constraint(expr= - m.x484 + m.x496 + m.b511 <= 1)

m.c1166 = Constraint(expr= - m.x482 + m.x494 - m.b509 >= -1)

m.c1167 = Constraint(expr= - m.x483 + m.x495 - m.b510 >= -1)

m.c1168 = Constraint(expr= - m.x484 + m.x496 - m.b511 >= -1)

m.c1169 = Constraint(expr= - 0.5*m.x485 + m.x494 + m.b509 <= 1)

m.c1170 = Constraint(expr= - 0.5*m.x486 + m.x495 + m.b510 <= 1)

m.c1171 = Constraint(expr= - 0.5*m.x487 + m.x496 + m.b511 <= 1)

m.c1172 = Constraint(expr= - 0.5*m.x485 + m.x494 - m.b509 >= -1)

m.c1173 = Constraint(expr= - 0.5*m.x486 + m.x495 - m.b510 >= -1)

m.c1174 = Constraint(expr= - 0.5*m.x487 + m.x496 - m.b511 >= -1)

m.c1175 = Constraint(expr=   m.x482 - 4.45628648004517*m.b509 <= 0)

m.c1176 = Constraint(expr=   m.x483 - 4.45628648004517*m.b510 <= 0)

m.c1177 = Constraint(expr=   m.x484 - 4.45628648004517*m.b511 <= 0)

m.c1178 = Constraint(expr=   m.x485 - 30*m.b509 <= 0)

m.c1179 = Constraint(expr=   m.x486 - 30*m.b510 <= 0)

m.c1180 = Constraint(expr=   m.x487 - 30*m.b511 <= 0)

m.c1181 = Constraint(expr=   m.x494 - 15*m.b509 <= 0)

m.c1182 = Constraint(expr=   m.x495 - 15*m.b510 <= 0)

m.c1183 = Constraint(expr=   m.x496 - 15*m.b511 <= 0)

m.c1184 = Constraint(expr=   5*m.b512 + m.x527 <= 0)

m.c1185 = Constraint(expr=   4*m.b513 + m.x528 <= 0)

m.c1186 = Constraint(expr=   6*m.b514 + m.x529 <= 0)

m.c1187 = Constraint(expr=   8*m.b515 + m.x530 <= 0)

m.c1188 = Constraint(expr=   7*m.b516 + m.x531 <= 0)

m.c1189 = Constraint(expr=   6*m.b517 + m.x532 <= 0)

m.c1190 = Constraint(expr=   6*m.b518 + m.x533 <= 0)

m.c1191 = Constraint(expr=   9*m.b519 + m.x534 <= 0)

m.c1192 = Constraint(expr=   4*m.b520 + m.x535 <= 0)

m.c1193 = Constraint(expr=   10*m.b521 + m.x536 <= 0)

m.c1194 = Constraint(expr=   9*m.b522 + m.x537 <= 0)

m.c1195 = Constraint(expr=   5*m.b523 + m.x538 <= 0)

m.c1196 = Constraint(expr=   6*m.b524 + m.x539 <= 0)

m.c1197 = Constraint(expr=   10*m.b525 + m.x540 <= 0)

m.c1198 = Constraint(expr=   6*m.b526 + m.x541 <= 0)

m.c1199 = Constraint(expr=   5*m.b512 + m.x527 >= 0)

m.c1200 = Constraint(expr=   4*m.b513 + m.x528 >= 0)

m.c1201 = Constraint(expr=   6*m.b514 + m.x529 >= 0)

m.c1202 = Constraint(expr=   8*m.b515 + m.x530 >= 0)

m.c1203 = Constraint(expr=   7*m.b516 + m.x531 >= 0)

m.c1204 = Constraint(expr=   6*m.b517 + m.x532 >= 0)

m.c1205 = Constraint(expr=   6*m.b518 + m.x533 >= 0)

m.c1206 = Constraint(expr=   9*m.b519 + m.x534 >= 0)

m.c1207 = Constraint(expr=   4*m.b520 + m.x535 >= 0)

m.c1208 = Constraint(expr=   10*m.b521 + m.x536 >= 0)

m.c1209 = Constraint(expr=   9*m.b522 + m.x537 >= 0)

m.c1210 = Constraint(expr=   5*m.b523 + m.x538 >= 0)

m.c1211 = Constraint(expr=   6*m.b524 + m.x539 >= 0)

m.c1212 = Constraint(expr=   10*m.b525 + m.x540 >= 0)

m.c1213 = Constraint(expr=   6*m.b526 + m.x541 >= 0)

m.c1214 = Constraint(expr=   m.b497 - m.b498 <= 0)

m.c1215 = Constraint(expr=   m.b497 - m.b499 <= 0)

m.c1216 = Constraint(expr=   m.b498 - m.b499 <= 0)

m.c1217 = Constraint(expr=   m.b500 - m.b501 <= 0)

m.c1218 = Constraint(expr=   m.b500 - m.b502 <= 0)

m.c1219 = Constraint(expr=   m.b501 - m.b502 <= 0)

m.c1220 = Constraint(expr=   m.b503 - m.b504 <= 0)

m.c1221 = Constraint(expr=   m.b503 - m.b505 <= 0)

m.c1222 = Constraint(expr=   m.b504 - m.b505 <= 0)

m.c1223 = Constraint(expr=   m.b506 - m.b507 <= 0)

m.c1224 = Constraint(expr=   m.b506 - m.b508 <= 0)

m.c1225 = Constraint(expr=   m.b507 - m.b508 <= 0)

m.c1226 = Constraint(expr=   m.b509 - m.b510 <= 0)

m.c1227 = Constraint(expr=   m.b509 - m.b511 <= 0)

m.c1228 = Constraint(expr=   m.b510 - m.b511 <= 0)

m.c1229 = Constraint(expr=   m.b512 + m.b513 <= 1)

m.c1230 = Constraint(expr=   m.b512 + m.b514 <= 1)

m.c1231 = Constraint(expr=   m.b512 + m.b513 <= 1)

m.c1232 = Constraint(expr=   m.b513 + m.b514 <= 1)

m.c1233 = Constraint(expr=   m.b512 + m.b514 <= 1)

m.c1234 = Constraint(expr=   m.b513 + m.b514 <= 1)

m.c1235 = Constraint(expr=   m.b515 + m.b516 <= 1)

m.c1236 = Constraint(expr=   m.b515 + m.b517 <= 1)

m.c1237 = Constraint(expr=   m.b515 + m.b516 <= 1)

m.c1238 = Constraint(expr=   m.b516 + m.b517 <= 1)

m.c1239 = Constraint(expr=   m.b515 + m.b517 <= 1)

m.c1240 = Constraint(expr=   m.b516 + m.b517 <= 1)

m.c1241 = Constraint(expr=   m.b518 + m.b519 <= 1)

m.c1242 = Constraint(expr=   m.b518 + m.b520 <= 1)

m.c1243 = Constraint(expr=   m.b518 + m.b519 <= 1)

m.c1244 = Constraint(expr=   m.b519 + m.b520 <= 1)

m.c1245 = Constraint(expr=   m.b518 + m.b520 <= 1)

m.c1246 = Constraint(expr=   m.b519 + m.b520 <= 1)

m.c1247 = Constraint(expr=   m.b521 + m.b522 <= 1)

m.c1248 = Constraint(expr=   m.b521 + m.b523 <= 1)

m.c1249 = Constraint(expr=   m.b521 + m.b522 <= 1)

m.c1250 = Constraint(expr=   m.b522 + m.b523 <= 1)

m.c1251 = Constraint(expr=   m.b521 + m.b523 <= 1)

m.c1252 = Constraint(expr=   m.b522 + m.b523 <= 1)

m.c1253 = Constraint(expr=   m.b524 + m.b525 <= 1)

m.c1254 = Constraint(expr=   m.b524 + m.b526 <= 1)

m.c1255 = Constraint(expr=   m.b524 + m.b525 <= 1)

m.c1256 = Constraint(expr=   m.b525 + m.b526 <= 1)

m.c1257 = Constraint(expr=   m.b524 + m.b526 <= 1)

m.c1258 = Constraint(expr=   m.b525 + m.b526 <= 1)

m.c1259 = Constraint(expr=   m.b497 - m.b512 <= 0)

m.c1260 = Constraint(expr= - m.b497 + m.b498 - m.b513 <= 0)

m.c1261 = Constraint(expr= - m.b497 - m.b498 + m.b499 - m.b514 <= 0)

m.c1262 = Constraint(expr=   m.b500 - m.b515 <= 0)

m.c1263 = Constraint(expr= - m.b500 + m.b501 - m.b516 <= 0)

m.c1264 = Constraint(expr= - m.b500 - m.b501 + m.b502 - m.b517 <= 0)

m.c1265 = Constraint(expr=   m.b503 - m.b518 <= 0)

m.c1266 = Constraint(expr= - m.b503 + m.b504 - m.b519 <= 0)

m.c1267 = Constraint(expr= - m.b503 - m.b504 + m.b505 - m.b520 <= 0)

m.c1268 = Constraint(expr=   m.b506 - m.b521 <= 0)

m.c1269 = Constraint(expr= - m.b506 + m.b507 - m.b522 <= 0)

m.c1270 = Constraint(expr= - m.b506 - m.b507 + m.b508 - m.b523 <= 0)

m.c1271 = Constraint(expr=   m.b509 - m.b524 <= 0)

m.c1272 = Constraint(expr= - m.b509 + m.b510 - m.b525 <= 0)

m.c1273 = Constraint(expr= - m.b509 - m.b510 + m.b511 - m.b526 <= 0)

m.c1274 = Constraint(expr=   m.b497 + m.b500 == 1)

m.c1275 = Constraint(expr=   m.b498 + m.b501 == 1)

m.c1276 = Constraint(expr=   m.b499 + m.b502 == 1)

m.c1277 = Constraint(expr=   m.b497 + m.b500 - m.b503 >= 0)

m.c1278 = Constraint(expr=   m.b498 + m.b501 - m.b504 >= 0)

m.c1279 = Constraint(expr=   m.b499 + m.b502 - m.b505 >= 0)

m.c1280 = Constraint(expr=   m.b497 + m.b500 - m.b506 >= 0)

m.c1281 = Constraint(expr=   m.b498 + m.b501 - m.b507 >= 0)

m.c1282 = Constraint(expr=   m.b499 + m.b502 - m.b508 >= 0)

m.c1283 = Constraint(expr=   m.b497 + m.b500 - m.b509 >= 0)

m.c1284 = Constraint(expr=   m.b498 + m.b501 - m.b510 >= 0)

m.c1285 = Constraint(expr=   m.b499 + m.b502 - m.b511 >= 0)
