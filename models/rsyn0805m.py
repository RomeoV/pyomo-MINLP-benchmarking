...
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        287       73       84      130        0        0        0        0
#  
#  Variable counts
#                   x        b        i      s1s      s2s       sc       si
#      Total     cont   binary  integer     sos1     sos2    scont     sint
#        171      102       69        0        0        0        0        0
#  FX      0        0        0        0        0        0        0        0
#  
#  Nonzero counts
#      Total    const       NL      DLL
...
m.obj = Objective(expr= - 4*m.x2 - 8*m.x7 - 5*m.x11 - 8*m.x23 + 23*m.x27 + 19*m.x29 - 10*m.x30 + 2*m.x33 + 3*m.x34
                        ...
                        - 23*m.b119 + 5*m.x158 - 2*m.x163 + 200*m.x164 + 250*m.x165 + 300*m.x166 - 5*m.b167 - 8*m.b168
                        - 6*m.b169 - 10*m.b170 - 6*m.b171, sense=maximize)
...
m.c264 = Constraint(expr=-log(1 + m.x153) + m.x155 + m.b167 <= 1)

m.c265 = Constraint(expr=   m.x153 - 10*m.b167 <= 0)

m.c266 = Constraint(expr=   m.x155 - 2.39789527279837*m.b167 <= 0)

m.c267 = Constraint(expr=-1.2*log(1 + m.x154) + m.x156 + m.b168 <= 1)

m.c268 = Constraint(expr=   m.x154 - 10*m.b168 <= 0)

m.c269 = Constraint(expr=   m.x156 - 2.87747432735804*m.b168 <= 0)

m.c270 = Constraint(expr= - 0.75*m.x160 + m.x164 + m.b169 <= 1)

m.c271 = Constraint(expr= - 0.75*m.x160 + m.x164 - m.b169 >= -1)

m.c272 = Constraint(expr=   m.x160 - 2.87747432735804*m.b169 <= 0)

m.c273 = Constraint(expr=   m.x164 - 2.15810574551853*m.b169 <= 0)

m.c274 = Constraint(expr=-1.5*log(1 + m.x161) + m.x165 + m.b170 <= 1)

m.c275 = Constraint(expr=   m.x161 - 2.87747432735804*m.b170 <= 0)

m.c276 = Constraint(expr=   m.x165 - 2.03277599268042*m.b170 <= 0)

m.c277 = Constraint(expr= - m.x162 + m.x166 + m.b171 <= 1)

m.c278 = Constraint(expr= - m.x162 + m.x166 - m.b171 >= -1)

m.c279 = Constraint(expr= - 0.5*m.x163 + m.x166 + m.b171 <= 1)

m.c280 = Constraint(expr= - 0.5*m.x163 + m.x166 - m.b171 >= -1)

m.c281 = Constraint(expr=   m.x162 - 2.87747432735804*m.b171 <= 0)

m.c282 = Constraint(expr=   m.x163 - 7*m.b171 <= 0)

m.c283 = Constraint(expr=   m.x166 - 3.5*m.b171 <= 0)

m.c284 = Constraint(expr=   m.b167 + m.b168 == 1)

m.c285 = Constraint(expr=   m.b167 + m.b168 - m.b169 >= 0)

m.c286 = Constraint(expr=   m.b167 + m.b168 - m.b170 >= 0)

m.c287 = Constraint(expr=   m.b167 + m.b168 - m.b171 >= 0)
