...
m.x77 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x78 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x79 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x80 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x81 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x82 = Var(within=Reals,bounds=(2.3094,6.9282),initialize=2.3094)
m.x83 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x84 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x85 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x86 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x87 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x88 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x89 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x90 = Var(within=Reals,bounds=(3.4641,10.3923),initialize=3.4641)
m.x91 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x92 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x93 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x94 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x95 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x96 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x97 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x98 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x99 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x100 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
m.x101 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x102 = Var(within=Reals,bounds=(1.7321,5.1962),initialize=1.7321)
...
m.c61 = Constraint(expr= - 0.433013*m.x76 - 0.144338*m.x78 <= -2)

m.c62 = Constraint(expr= - 0.144338*m.x76 - 0.433013*m.x78 <= -2)

m.c63 = Constraint(expr= - 0.433013*m.x77 - 0.144338*m.x79 <= -2)

m.c64 = Constraint(expr= - 0.144338*m.x77 - 0.433013*m.x79 <= -2)

m.c65 = Constraint(expr= - 0.433013*m.x80 - 0.144338*m.x82 <= -2)

m.c66 = Constraint(expr= - 0.144338*m.x80 - 0.433013*m.x82 <= -2)

m.c67 = Constraint(expr= - 0.288675*m.x84 - 0.096225*m.x86 <= -2)

m.c68 = Constraint(expr= - 0.096225*m.x84 - 0.288675*m.x86 <= -2)

m.c69 = Constraint(expr= - 0.288675*m.x88 - 0.096225*m.x90 <= -2)

m.c70 = Constraint(expr= - 0.096225*m.x88 - 0.288675*m.x90 <= -2)

m.c71 = Constraint(expr= - 0.577334*m.x92 - 0.192456*m.x94 <= -2)

m.c72 = Constraint(expr= - 0.192448*m.x92 - 0.577356*m.x94 <= -2)

m.c73 = Constraint(expr= - 0.577334*m.x96 - 0.192456*m.x98 <= -2)

m.c74 = Constraint(expr= - 0.192448*m.x96 - 0.577356*m.x98 <= -2)

m.c75 = Constraint(expr= - 0.577334*m.x100 - 0.192456*m.x102 <= -2)

m.c76 = Constraint(expr= - 0.192448*m.x100 - 0.577356*m.x102 <= -2)
