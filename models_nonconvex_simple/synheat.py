...
m.x13 = Var(within=Reals,bounds=(370,650),initialize=370)
m.x14 = Var(within=Reals,bounds=(370,650),initialize=370)
m.x15 = Var(within=Reals,bounds=(370,650),initialize=370)
m.x16 = Var(within=Reals,bounds=(370,590),initialize=370)
m.x17 = Var(within=Reals,bounds=(370,590),initialize=370)
m.x18 = Var(within=Reals,bounds=(370,590),initialize=370)
...
m.obj = Objective(expr=150*(2*m.x25/(1e-6 + (1e-6 + 0.5*m.x41*m.x42*(m.x41 + m.x42))**0.33333) + 2*m.x26/(1e-6 + (1e-6
                        + 0.5*m.x42*m.x43*(m.x42 + m.x43))**0.33333) + 2*m.x28/(1e-6 + (1e-6 + 0.5*m.x44*m.x45*(m.x44 + 
                       m.x45))**0.33333) + 2*m.x29/(1e-6 + (1e-6 + 0.5*m.x45*m.x46*(m.x45 + m.x46))**0.33333) + 2*m.x31/
                       (1e-6 + (1e-6 + 0.5*m.x47*m.x48*(m.x47 + m.x48))**0.33333) + 2*m.x32/(1e-6 + (1e-6 + 0.5*m.x48*
                       m.x49*(m.x48 + m.x49))**0.33333) + 2*m.x34/(1e-6 + (1e-6 + 0.5*m.x50*m.x51*(m.x50 + m.x51))**
                       0.33333) + 2*m.x35/(1e-6 + (1e-6 + 0.5*m.x51*m.x52*(m.x51 + m.x52))**0.33333)) + 150*(1.2*m.x39/(
                       1e-6 + 30*m.x55*(15 + 0.5*m.x55))**0.33333 + 1.2*m.x40/(1e-6 + 180*m.x56*(90 + 0.5*m.x56))**
                       0.33333) + 150*(2*m.x37/(1e-6 + 35*m.x53*(70 + m.x53))**0.33333 + 2*m.x38/(1e-6 + 35*m.x54*(70 + 
                       m.x54))**0.33333) + 80*m.x39 + 80*m.x40 + 15*m.x37 + 15*m.x38 + 5500*m.b1 + 5500*m.b2 + 5500*m.b3
                        + 5500*m.b4 + 5500*m.b5 + 5500*m.b6 + 5500*m.b7 + 5500*m.b8 + 5500*m.b9 + 5500*m.b10
                        + 5500*m.b11 + 5500*m.b12 + 29995.6190569812*m.x27 + 29995.6190569812*m.x30
                        + 29995.6190569812*m.x33 + 29995.6190569812*m.x36 + 0.0024, sense=minimize)
...
m.c5 = Constraint(expr=   10*m.x15 - m.x37 == 3700)

m.c6 = Constraint(expr=   20*m.x18 - m.x38 == 7400)

m.c7 = Constraint(expr= - m.x25 - m.x26 - m.x28 - m.x29 - m.x37 == -2800)

m.c8 = Constraint(expr= - m.x31 - m.x32 - m.x34 - m.x35 - m.x38 == -4400)

m.c9 = Constraint(expr=   15*m.x19 - 15*m.x20 - m.x25 - m.x31 == 0)

m.c10 = Constraint(expr=   15*m.x20 - 15*m.x21 - m.x26 - m.x32 == 0)

m.c11 = Constraint(expr=   13*m.x22 - 13*m.x23 - m.x28 - m.x34 == 0)

m.c12 = Constraint(expr=   13*m.x23 - 13*m.x24 - m.x29 - m.x35 == 0)
